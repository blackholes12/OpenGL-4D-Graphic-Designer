...
public:
    Coordinate4D() {
        ...
        LineVertex4D lineVertices4D[] = {
            ...
            //glm::vec4(arrowLength,-0.5f,-0.5f,-0.5f),glm::vec3(1,0,0),
            //glm::vec4(arrowLength,-0.5f,-0.5f,-0.5f) + glm::vec4(-arrowHeight,arrowWidth,arrowWidth,arrowWidth),glm::vec3(1,0,0),
            //
            //glm::vec4(arrowLength,-0.5f,-0.5f,-0.5f),glm::vec3(1,0,0),
            //glm::vec4(arrowLength,-0.5f,-0.5f,-0.5f) + glm::vec4(-arrowHeight,-arrowWidth,arrowWidth,arrowWidth),glm::vec3(1,0,0),
            //
            ...
            //
            //
            //glm::vec4(-0.5f,arrowLength,-0.5f,-0.5f),glm::vec3(0,1,0),
            //glm::vec4(-0.5f,arrowLength,-0.5f,-0.5f) + glm::vec4(arrowWidth ,-arrowHeight,arrowWidth,arrowWidth),glm::vec3(0,1,0),
            //
            //glm::vec4(-0.5f,arrowLength,-0.5f,-0.5f),glm::vec3(0,1,0),
            //glm::vec4(-0.5f,arrowLength,-0.5f,-0.5f) + glm::vec4(arrowWidth ,-arrowHeight,arrowWidth,-arrowWidth),glm::vec3(0,1,0),
            //
            ...
            //
            //
            //glm::vec4(-0.5f,-0.5f,arrowLength,-0.5f),glm::vec3(0,0,1),
            //glm::vec4(-0.5f,-0.5f,arrowLength,-0.5f) + glm::vec4(arrowWidth ,arrowWidth,-arrowHeight,arrowWidth),glm::vec3(0,0,1),
            //
            //glm::vec4(-0.5f,-0.5f,arrowLength,-0.5f),glm::vec3(0,0,1),
            //glm::vec4(-0.5f,-0.5f,arrowLength,-0.5f) + glm::vec4(arrowWidth ,arrowWidth,-arrowHeight,-arrowWidth),glm::vec3(0,0,1),
            //
            ...
            //
            //
            //glm::vec4(-0.5f,-0.5f,-0.5f,arrowLength),glm::vec3(0.5f,0,1),
            //glm::vec4(-0.5f,-0.5f,-0.5f,arrowLength) + glm::vec4(arrowWidth ,arrowWidth,arrowWidth,-arrowHeight),glm::vec3(0.5f,0,1),
            //
            //glm::vec4(-0.5f,-0.5f,-0.5f,arrowLength),glm::vec3(0.5f,0,1),
            //glm::vec4(-0.5f,-0.5f,-0.5f,arrowLength) + glm::vec4(arrowWidth ,arrowWidth,-arrowWidth,-arrowHeight),glm::vec3(0.5f,0,1),
            //
            ...
            glm::vec4(0.5f,0.5f,0.5f,0.5f),glm::vec3(1.f,0.f,0.f),glm::vec4(-0.5f,0.5f,0.5f,0.5f),glm::vec3(1.f,0.f,0.f),
            glm::vec4(0.5f,-0.5f,0.5f,0.5f),glm::vec3(1.f,0.f,0.f),glm::vec4(-0.5f,-0.5f,0.5f,0.5f),glm::vec3(1.f,0.f,0.f),
            glm::vec4(0.5f,0.5f,-0.5f,0.5f),glm::vec3(1.f,0.f,0.f),glm::vec4(-0.5f,0.5f,-0.5f,0.5f),glm::vec3(1.f,0.f,0.f),
            glm::vec4(0.5f,-0.5f,-0.5f,0.5f),glm::vec3(1.f,0.f,0.f),glm::vec4(-0.5f,-0.5f,-0.5f,0.5f),glm::vec3(1.f,0.f,0.f),
            glm::vec4(0.5f,0.5f,0.5f,-0.5f),glm::vec3(1.f,0.f,0.f),glm::vec4(-0.5f,0.5f,0.5f,-0.5f),glm::vec3(1.f,0.f,0.f),
            ...
            glm::vec4(0.5f,0.5f,0.5f,0.5f),glm::vec3(0.f,1.f,0.f),glm::vec4(0.5f,-0.5f,0.5f,0.5f),glm::vec3(0.f,1.f,0.f),
            glm::vec4(-0.5f,0.5f,0.5f,0.5f),glm::vec3(0.f,1.f,0.f),glm::vec4(-0.5f,-0.5f,0.5f,0.5f),glm::vec3(0.f,1.f,0.f),
            glm::vec4(0.5f,0.5f,-0.5f,0.5f),glm::vec3(0.f,1.f,0.f),glm::vec4(0.5f,-0.5f,-0.5f,0.5f),glm::vec3(0.f,1.f,0.f),
            glm::vec4(0.5f,0.5f,0.5f,-0.5f),glm::vec3(0.f,1.f,0.f),glm::vec4(0.5f,-0.5f,0.5f,-0.5f),glm::vec3(0.f,1.f,0.f),
            glm::vec4(-0.5f,0.5f,-0.5f,0.5f),glm::vec3(0.f,1.f,0.f),glm::vec4(-0.5f,-0.5f,-0.5f,0.5f),glm::vec3(0.f,1.f,0.f),
            ...
            glm::vec4(0.5f,0.5f,0.5f,0.5f),glm::vec3(0.f,0.f,1.f),glm::vec4(0.5f,0.5f,-0.5f,0.5f),glm::vec3(0.f,0.f,1.f),
            glm::vec4(-0.5f,0.5f,0.5f,0.5f),glm::vec3(0.f,0.f,1.f),glm::vec4(-0.5f,0.5f,-0.5f,0.5f),glm::vec3(0.f,0.f,1.f),
            glm::vec4(0.5f,-0.5f,0.5f,0.5f),glm::vec3(0.f,0.f,1.f),glm::vec4(0.5f,-0.5f,-0.5f,0.5f),glm::vec3(0.f,0.f,1.f),
            glm::vec4(0.5f,0.5f,0.5f,-0.5f),glm::vec3(0.f,0.f,1.f),glm::vec4(0.5f,0.5f,-0.5f,-0.5f),glm::vec3(0.f,0.f,1.f),
            glm::vec4(-0.5f,-0.5f,0.5f,0.5f),glm::vec3(0.f,0.f,1.f),glm::vec4(-0.5f,-0.5f,-0.5f,0.5f),glm::vec3(0.f,0.f,1.f),
            ...
            glm::vec4(0.5f,0.5f,0.5f,0.5f),glm::vec3(0.5f,0.f,1.f),glm::vec4(0.5f,0.5f,0.5f,-0.5f),glm::vec3(0.5f,0.f,1.f),
            glm::vec4(-0.5f,0.5f,0.5f,0.5f),glm::vec3(0.5f,0.f,1.f),glm::vec4(-0.5f,0.5f,0.5f,-0.5f),glm::vec3(0.5f,0.f,1.f),
            glm::vec4(0.5f,-0.5f,0.5f,0.5f),glm::vec3(0.5f,0.f,1.f),glm::vec4(0.5f,-0.5f,0.5f,-0.5f),glm::vec3(0.5f,0.f,1.f),
            glm::vec4(0.5f,0.5f,-0.5f,0.5f),glm::vec3(0.5f,0.f,1.f),glm::vec4(0.5f,0.5f,-0.5f,-0.5f),glm::vec3(0.5f,0.f,1.f),
            glm::vec4(-0.5f,-0.5f,0.5f,0.5f),glm::vec3(0.5f,0.f,1.f),glm::vec4(-0.5f,-0.5f,0.5f,-0.5f),glm::vec3(0.5f,0.f,1.f),
