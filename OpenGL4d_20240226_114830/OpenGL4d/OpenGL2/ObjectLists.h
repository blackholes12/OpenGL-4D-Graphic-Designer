...
static void erase_joint4d(std::vector<Stick4D*>* sticks4D,std::vector<Spring4D*>* springs4D, std::vector<HingeConstraint*>* hingeConstraints, unsigned int index0)
{
...
static void shift_joint4d(std::vector<Stick4D*> sticks4D, std::vector<Spring4D*> springs4D, std::vector<HingeConstraint*> hingeConstraints, unsigned int index0,int count)
{
    ...
    for (HingeConstraint* hingeConstraint : hingeConstraints)
    {
