        ...
        abs(a->position4D.w - b->position4D.w) < radiousA + radiousB)
    {
            ...
            abs(posBToA.w) < a->scale4D.w / 2.f + radiousB)
        {
            ...
            if (gjk(a, b, 12, &simplex))
            {
                ...
                glm::vec4 normal = epa2(a, b, 24, simplex, &depth, &supportPoints1,&supportPoints2);
                if (depth > 0.f)
                {
                    bool isMuti = false;
                    ...
                    if (supportPoints1.size() == 4)
                    {
                        ...
                        if (supportPoints2.size() == 8)
                        {
                            ...
                            for (int i = 0; i < 4; i++)
                            {
                                depth2[i] = dot(supportPoints1[i]- supportPoints2[0], normal);
                            }
                    ...
                    if (supportPoints2.size() == 4)
                    {
                        if (supportPoints1.size() == 8)
                        {
                            ...
                            for (int i = 0; i < 4; i++)
                            {
                                depth2[i] = dot(supportPoints1[0] - supportPoints2[i], normal);
                            }
                    ...
                    if (supportPoints1.size() == 8)
                    {
                        if (supportPoints2.size() == 8)
                        {
                            ...
                            else
                            {
                                ...
                                for (int i = 0; i < 8; i++)
                                {
                                    depth3[i] = dot(supportPoints1[0] - supportPoints2[i], normal);
                                }
                        ...
                        if (supportPoints1.size() > 3)
                        {
                            ...
                            else
                            {
                                ...
                                if (scaleRate > 4.f)
                                {
                                    ...
                                    {
                                        collisions.push_back(new Collision(index1, index2, (float)supportPoints2.size(), (float)supportPoints2.size(), inverse(normal, isInverse), depth, supportPoints2[i] + depth * normal / 2.f));
                                    }
                                }
                                else if (1.f/scaleRate > 4.f)
                                {
                                ...
                                else
                                {
                                    for (int i = 0; i < supportPoints1.size(); i++)
                                    {
                                        collisions.push_back(new Collision(index1, index2, (float)supportPoints1.size() + (float)supportPoints2.size(), (float)(supportPoints1.size() + supportPoints2.size()), inverse(normal, isInverse), depth, supportPoints1[i] - depth * normal / 2.f));
                                    }
                                    for (int i = 0; i < supportPoints2.size(); i++)
                                    {
                                        collisions.push_back(new Collision(index1, index2, (float)supportPoints1.size() + (float)supportPoints2.size(), (float)(supportPoints1.size() + supportPoints2.size()), inverse(normal, isInverse), depth, supportPoints2[i] + depth * normal / 2.f));
                                    }
                                }
                            }
                        }
            ...
            if (depth > 0.f)
            {
                ...
                if (supportPoints1.size() > 4)
                {
                    ...
                    else
                    {
                        for (int i = 0; i < supportPoints1.size(); i++)
                        {
                            collisions.push_back(new Collision(index1, index2, (float)supportPoints1.size(), (float)supportPoints1.size(), inverse(normal, isInverse), depth, supportPoints1[i] - depth * normal / 2.f));
                        }
                    }
                }
                if (supportPoints2.size() > 4)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            for (int i = 0; i < supportPoints2.size(); i++)
                            {
                                collisions.push_back(new Collision(index1, index2, (float)supportPoints1.size() + (float)supportPoints2.size(), supportPoints1.size() + supportPoints2.size(), inverse(normal, isInverse), depth, supportPoints2[i] + depth * normal / 2.f));
                            }
                            for (int i = 0; i < supportPoints1.size(); i++)
                            {
                                collisions.push_back(new Collision(index1, index2, (float)supportPoints1.size() + (float)supportPoints2.size(), supportPoints1.size() + supportPoints2.size(), inverse(normal, isInverse), depth, supportPoints1[i] - depth * normal / 2.f));
                            }
                        }
                    }
                }
