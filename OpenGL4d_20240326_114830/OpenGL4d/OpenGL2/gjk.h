...
struct ExpandingPolytope2
{
    ...
    void expand(glm::vec4 newPoint4D)
    {
        ...
        if (!isRemove)
        {
            ...
            addIndex = this->vertices4D.size()-1;
        }
        if (!isRemove)
        {
            for (int i = 0; i < this->ePTetras.size(); i++)
            {
                if (dot(this->ePTetras[i].normal4D, newPoint4D - this->vertices4D[this->ePTetras[i].tetra4DIndexs[0]]) > 0.00001f)
                {
                    addTetrasIndexs.push_back(glm::ivec4(ePTetras[i].tetra4DIndexs[0], ePTetras[i].tetra4DIndexs[1], ePTetras[i].tetra4DIndexs[2], addIndex));
                    addTetrasIndexs.push_back(glm::ivec4(ePTetras[i].tetra4DIndexs[0], ePTetras[i].tetra4DIndexs[1], ePTetras[i].tetra4DIndexs[3], addIndex));
                    addTetrasIndexs.push_back(glm::ivec4(ePTetras[i].tetra4DIndexs[0], ePTetras[i].tetra4DIndexs[2], ePTetras[i].tetra4DIndexs[3], addIndex));
                    addTetrasIndexs.push_back(glm::ivec4(ePTetras[i].tetra4DIndexs[1], ePTetras[i].tetra4DIndexs[2], ePTetras[i].tetra4DIndexs[3], addIndex)); 
