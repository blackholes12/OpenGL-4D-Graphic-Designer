...
public:
	...
	glm::vec3 color;
	float radius;
	PointLight4D(size_t texture3DIndex, glm::vec4 position4D, VectorIndex* index, size_t id, float intensity = 1.f, glm::vec3 color = glm::vec3(1.f),
		float radius = 10.f)
	{
	...
	~PointLight4D()
	{
		this->index = nullptr, delete this->index;
...
static glm::vec3 sunColor(glm::vec3(1.f, 0.9569483420118626f, 0.9440667544265177f) * 1.060364313261f);
