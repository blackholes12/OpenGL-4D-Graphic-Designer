...
{
    return support(a, direction4D) - support(b, -direction4D) + glm::vec4(10000 + rand() % 100, 10000 + rand() % 100, 10000 + rand() % 100, 10000 + rand() % 100)*0.00000003f;
}
...
{
    glm::vec4 a(support_of_cso(s1, s2, s1->position4D-s2->position4D));
    *simplex = Simplex(a);
    glm::vec4 d(-a);
