...
void Game::imgui_use() {
	...
	if (ImGui::TreeNodeEx("Controls", 2))
	{
		...
		{
			this->rigidBodies4D[0] = new RigidBody4D("Player", Hypercapsule(glm::vec4(0.4f, 0.4f, 1.4f, 0.4f)), glm::vec4(0.f, 64.7f, 0.f, 0.f), alg::bivec4(0.f, 0.f, 0.f, 90.f), glm::vec4(0.4f, 0.4f, 1.4f, 0.4f), 65.f, 0.f, 1.265f, 0.25f, true, false, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, PURE_WHITE, 0.f, glm::vec4(1.f, 1.f, 1.f, 0.25f), CAPSULE4D, WALLD4);
		}
	...
	ImGui::Text("%.1f Degree Fov", this->camera.fov);
	ImGui::Text("%.1f m Near Plane", this->camera.nearPlane);
	ImGui::Spacing();
