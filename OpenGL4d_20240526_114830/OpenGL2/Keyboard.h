...
void Game::updateKeyboardInput()
{
	...
	if (!this->curserMode)
	{
		...
		if (this->mode == SHOOTING)
		{
			...
			{
				this->hitIndex = ray::detect_object4d_index(this->rigidBodies4D, this->dynamites4D2, this->groups, this->walls4D, this->dynamites4D,this->sticks4D,this->springs4D, true, true,true, true, this->camera.position4D, this->camera.forward4D, this->camera.right4D, &this->hitPosNear);
			}
		...
		if (this->mode == CONTROLING)
		{
			...
			if (this->controlType == 0 || this->controlType == 1)
			{
				if (this->inputs[2]->getMouseOnPress(this->window, GLFW_MOUSE_BUTTON_2))
				{
					this->hitIndex = ray::detect_object4d_index(this->rigidBodies4D, this->dynamites4D2, this->groups, this->walls4D, this->dynamites4D, this->sticks4D, this->springs4D, false,false, true, false, this->camera.position4D, this->camera.forward4D, this->camera.right4D, &this->hitPosNear);
					if (this->hitIndex != -1)
					{
		...
		if (this->mode == BUILDING) {
			...
			if (glfwGetKey(this->window, GLFW_KEY_LEFT_CONTROL) == GLFW_PRESS || glfwGetKey(this->window, GLFW_KEY_RIGHT_CONTROL) == GLFW_PRESS)
			{
				...
				{
					this->isFindPoint = ray::detect_object4d_index(this->rigidBodies4D, this->dynamites4D2, this->groups, this->walls4D, this->dynamites4D, this->sticks4D, this->springs4D, true,true, true, true, this->camera.position4D, this->camera.forward4D, this->camera.right4D, &this->hittingPos4D) != -1;
			...
			if (this->inputs[2]->getMouseOnPress(this->window, GLFW_MOUSE_BUTTON_2))
			{
				...
				if (this->isFindPoint) {
					...
					{ 
						...
						{
						case HYPERCUBE: { this->walls4D.push_back(new Wall4D(this->buildTag, Hypercube(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, BOX4D, this->buildShader)); break; }
						case HYPERSPHERE: { this->walls4D.push_back(new Wall4D(this->buildTag, Hypersphere(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, SPHERE4D, this->buildShader)); break; }
						case HYPERCAPSULE: { this->walls4D.push_back(new Wall4D(this->buildTag, Hypercapsule(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, CAPSULE4D, this->buildShader)); break; }
						case HYPERCYLINDER: { this->walls4D.push_back(new Wall4D(this->buildTag, Hypercylinder(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, MESH4D, this->buildShader)); break; }
						case HYPERCONE: { this->walls4D.push_back(new Wall4D(this->buildTag, Hypercone(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, MESH4D, this->buildShader)); break; }
						case HYPERPOT: { this->walls4D.push_back(new Wall4D(this->buildTag, Hyperpot(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, MESH4D, this->buildShader)); break; }
						case TRIPRISM: { this->walls4D.push_back(new Wall4D(this->buildTag, TriPrism(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, MESH4D, this->buildShader)); break; }
						case HYPERSLOPE: { this->walls4D.push_back(new Wall4D(this->buildTag, Hyperslope(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, MESH4D, this->buildShader)); break; }
						case HYPERQUAD: { this->walls4D.push_back(new Wall4D(this->buildTag, DoubleQuads4d(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, MESH4D, this->buildShader)); break; }
						case PENTACHORON: { this->walls4D.push_back(new Wall4D(this->buildTag, Pentachoron(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, MESH4D, this->buildShader)); break; }
						case HYPERPYRAMID: { this->walls4D.push_back(new Wall4D(this->buildTag, Pyramid4D(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, MESH4D, this->buildShader)); break; }
						case HEXADECACHORON: { this->walls4D.push_back(new Wall4D(this->buildTag, Hexadecachoron(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, MESH4D, this->buildShader)); break; }
						case HEXACOSICHORON: { this->walls4D.push_back(new Wall4D(this->buildTag, Hexacosichoron(this->buildScale / 2.f), get_cap_position4D(this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f, 0.f, 0.f)), this->buildRotation, this->buildScale, this->buildParameter.z, this->buildParameter.w, this->isSpecular, this->buildTexture, this->metal, this->buildColor, MESH4D, this->buildShader)); break; }
						}
					...
					case BUILD_BILLIARD:
					{
						shift_animation4D(this->shifts4D, this->floats4D, this->rotates4D, this->rigidBodies4D.size(), 1);
						shift_joint4d(this->sticks4D, this->springs4D, &this->hingeConstraintsVec, this->rigidBodies4D.size(), 1);
						generate_billiard4D(this->hittingPos4D + glm::vec4(0.f, 0.0525f / 2.f, 0.f, 0.f), this->initialVelocity, this->initialAngularVelocity, this->buildTexture, &this->rigidBodies4D, this->isGravity, this->metal, this->buildColor, this->buildShader);
						break;
					}
					case BUILD_DYNAMITE:
					{
						...
						if (this->hitIndex >= size_of_objects4d(this->rigidBodies4D, this->dynamites4D2, this->groups, this->walls4D) || this->hitIndex < size_of_objects4d(this->rigidBodies4D, this->dynamites4D2, this->groups))
						{
							...
							if (isInitial)
							{
								...
								if (size != 0)
								{
									...
									{
										this->springs4D.push_back(new Spring4D(glm::vec4(0.f), this->hitIndex, -1, this->springLength, this->springStrength, GREEN, this->buildColor, this->buildShader));
									}
		...
		if (this->mode == DELETING)
		{
			if (this->inputs[2]->getMouseOnPress(this->window, GLFW_MOUSE_BUTTON_2))
			{
				this->hitIndex = ray::detect_object4d_index(this->rigidBodies4D, this->dynamites4D2, this->groups, this->walls4D, this->dynamites4D, this->sticks4D, this->springs4D, true, true,true, false, this->camera.position4D, this->camera.forward4D, this->camera.right4D, &this->hitPosNear);
				if (this->hitIndex > -1)
				{
					if (this->hitIndex < size_of_objects4d(this->rigidBodies4D, this->dynamites4D2))
					{
		...
		if (this->mode == AREA_DELETING)
		{
			if (this->inputs[2]->getMouseOnPress(this->window, GLFW_MOUSE_BUTTON_2))
			{
				ray::detect_object4d_index(this->rigidBodies4D, this->dynamites4D2, this->groups, this->walls4D, this->dynamites4D, this->sticks4D, this->springs4D, true, true,true, true, this->camera.position4D, this->camera.forward4D, this->camera.right4D, &this->hittingPos4D);
			}
			if (glfwGetMouseButton(this->window, GLFW_MOUSE_BUTTON_2) == GLFW_PRESS)
			{
				glm::vec4 endPos;
				ray::detect_object4d_index(this->rigidBodies4D, this->dynamites4D2, this->groups, this->walls4D, this->dynamites4D, this->sticks4D, this->springs4D, true, true,true, true, this->camera.position4D, this->camera.forward4D, this->camera.right4D, &endPos);
