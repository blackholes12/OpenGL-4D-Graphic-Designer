...
void Game::updateObjects()
{
	...
	if (this->isFixedTime)
	{
		phy::update_physic4D(this->rigidBodies4D,this->dynamites4D2, this->groups,this->walls4D,this->dynamites4D, this->waters4D,&this->collisionsVec, this->sticks4D, this->springs4D,this->hingeConstraintsVec, 1 / 60.f);
	}
