...
namespace pentachoron{
	...
	{
	glm::ivec2(4,0),glm::ivec2(0,0),glm::ivec2(1,0),glm::ivec2(3,0),
	glm::ivec2(4,1),glm::ivec2(2,1),glm::ivec2(0,1),glm::ivec2(3,1),
	glm::ivec2(4,2),glm::ivec2(1,2),glm::ivec2(2,2),glm::ivec2(3,2),
	glm::ivec2(4,3),glm::ivec2(1,3),glm::ivec2(0,3),glm::ivec2(2,3),
	glm::ivec2(3,4),glm::ivec2(1,4),glm::ivec2(2,4),glm::ivec2(0,4)
	};
}
