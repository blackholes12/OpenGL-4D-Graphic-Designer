...
public:
	Hexacosichoron(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(hexacosichoron::vertices4D, sizeof(hexacosichoron::vertices4D) / sizeof(glm::vec4), hexacosichoron::normals4D,hexacosichoron::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,1);
	}
	~Hexacosichoron() {
