...
void Game::startObjects(int level,unsigned type,const char* filePath)
{
	if (type == 0)
	{
		...
		case 1:
		{
			...
			this->rigidBodies4D.push_back(new RigidBody4D("Hypersphere", Hypersphere(glm::vec4(0.5f)), glm::vec4(-8.f, 66.4f, 0.f, 0), alg::bivec4(), glm::vec4(0.5f), 1.f, 0.5f, 1.265f, 1.f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[PURE_RED_GREEN], 0.25f, glm::vec4(1.f), SPHERE4D, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypersphere", Hypersphere(glm::vec4(0.5f)), glm::vec4(-11.f, 66.4f, 0.f, 0), alg::bivec4(), glm::vec4(0.5f), 1.f, 0.5f, 1.265f, 1.f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[PURE_RED_HARFGREEN], 0.25f, glm::vec4(1.f), SPHERE4D, this->shaders[WALLD4]));
			...
			this->rigidBodies4D.push_back(new RigidBody4D("Glass4D", Hexacosichoron(glm::vec4(0.707106781186547f)), glm::vec4(-2.f, 65.7f, 0.f, 0.f), alg::bivec4(), glm::vec4(0.5f), 65.f, 0.f, 1.265f, 0.25f, false, false, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[GLASS], 0.75f, glm::vec4(1.1f, 1.5f, 0.f, 2.f), MESH4D, this->shaders[WALLD4]));
		...
		case 2:
		{
			...
			this->walls4D.push_back(new Wall4D("Hypersphere", Hypersphere(glm::vec4(0.5f)), glm::vec4(3.95f, 64.35f, 0.f, -0.45f), alg::bivec4(), glm::vec4(0.5f), 1.265f, 0.f, true, this->wallTexs3D[PURE_RED_GREEN], 0.25f, glm::vec4(1.f), SPHERE4D, this->shaders[WALLD4]));
			this->walls4D.push_back(new Wall4D("Hypersphere", Hypersphere(glm::vec4(0.5f)), glm::vec4(3.05f, 64.35f, 0.f, -0.45f), alg::bivec4(), glm::vec4(0.5f), 1.265f, 0.f, true, this->wallTexs3D[PURE_RED_GREEN], 0.25f, glm::vec4(1.f), SPHERE4D, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercube", Hypercube(glm::vec4(1.5f, 1.f, 6.f, 1.5f) / 2.f), glm::vec4(3.5f, 65.1f, 0.5f, 0.f), alg::bivec4(), glm::vec4(1.5f, 1.f, 6.f, 1.5f), 3.f, 4.5f, 1.265f, 0.25f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[WOODY], 0.f, glm::vec4(1.f), BOX4D, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercube", Hypercube(glm::vec4(0.5f) / 2.f), glm::vec4(3.5f, 65.85f, 2.f, 0.f), alg::bivec4(), glm::vec4(0.5f), 1.f, 0.33f, 1.265f, 0.25f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[PURE_RED], 0.f, glm::vec4(1.f), BOX4D, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercube", Hypercube(glm::vec4(0.5f) / 2.f), glm::vec4(3.5f, 67.85f, -1.25f, 0.f), alg::bivec4(), glm::vec4(0.5f), 1.5f, 0.5f, 1.265f, 0.25f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[WHITECONCRETE], 0.5f, glm::vec4(1.f), BOX4D, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercube", Hypercube(glm::vec4(0.5f) / 2.f), glm::vec4(3.5f, 67.85f, -1.75f, 0.f), alg::bivec4(), glm::vec4(0.5f), 1.5f, 0.5f, 1.265f, 0.25f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[WHITECONCRETE], 0.5f, glm::vec4(1.f), BOX4D, this->shaders[WALLD4]));
