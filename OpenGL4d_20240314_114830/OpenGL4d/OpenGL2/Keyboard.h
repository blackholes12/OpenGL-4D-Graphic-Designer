				...
				if (this->isFindPoint) {
					...
					if (this->buildMode == BUILD_DYNAMITE)
					{
						...
						if (this->isRigidBody)
						{
							...
							generate_dynamite4D(this->hittingPos4D + glm::vec4(0, -0.01f, 0, 0), this->wallTexs3D[WHITECONCRETE], &this->dynamites4D2, this->isGravity, this->shaders[this->buildShader]);
						}
					}
				}
