...
static void generate_pool_table4D(glm::vec4 position, glm::vec4 scale, float height, bool isFrameReflect, unsigned int framecolor, bool isTopReflect, unsigned int topTextureIndex, bool isLagReflect, unsigned int lagTextureIndex, std::vector<Wall4D*> *walls4D, unsigned int shaderIndex)
{
	...
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4(scale.x + 0.04f, 0.04f, scale.z + 0.04f, scale.w + 0.04f) / 2.f), glm::vec4(0.f, height, 0.f, 0.f) + position, alg::bivec4(), glm::vec4(scale.x + 0.04f, 0.04f, scale.z + 0.04f, scale.w + 0.04f), 0.f, 0.f, isTopReflect, topTextureIndex,glm::vec4(0.5f,1.25f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Noneshape(), glm::vec4(0.f, height/2.f+0.01f, 0.f, 0.f) + position, alg::bivec4(), glm::vec4(scale.x + 0.4f, 0.02f+ height, scale.z + 0.4f, scale.w + 0.4f), 0.f, 0.f, isTopReflect, topTextureIndex,glm::vec4(0.5f, 1.25f, 0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, shaderIndex));

	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4(0.025f, 0.1f, scale.z, scale.w) / 2.f), glm::vec4(scale.x / 2.f + 0.0125f, height + 0.05f, 0.f, 0.f) + position, alg::bivec4(), glm::vec4(0.025f, 0.1f, scale.z, scale.w), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f,1.25f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4(0.025f, 0.1f, scale.z, scale.w) / 2.f), glm::vec4(-scale.x / 2.f - 0.0125f, height + 0.05f, 0.f, 0.f) + position, alg::bivec4(), glm::vec4(0.025f, 0.1f, scale.z, scale.w), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f,1.25f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4(scale.x + 0.05f, 0.1f, 0.025f, scale.w) / 2.f), glm::vec4(0.f, height + 0.05f, scale.z / 2.f + 0.0125f, 0.f) + position, alg::bivec4(), glm::vec4(scale.x + 0.05f, 0.1f, 0.025f, scale.w), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f,1.25f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4(scale.x + 0.05f, 0.1f, 0.025f, scale.w) / 2.f), glm::vec4(0.f, height + 0.05f, -scale.z / 2.f - 0.0125f, 0.f) + position, alg::bivec4(), glm::vec4(scale.x + 0.05f, 0.1f, 0.025f, scale.w), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f,1.25f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4(scale.x + 0.05f, 0.1f, scale.z + 0.05f, 0.025f) / 2.f), glm::vec4(0.f, height + 0.05f, 0.f, scale.w / 2.f + 0.0125f) + position, alg::bivec4(), glm::vec4(scale.x + 0.05f, 0.1f, scale.z + 0.05f, 0.025f), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f,1.25f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4(scale.x + 0.05f, 0.1f, scale.z + 0.05f, 0.025f) / 2.f), glm::vec4(0.f, height + 0.05f, 0.f, -scale.w / 2.f - 0.0125f) + position, alg::bivec4(), glm::vec4(scale.x + 0.05f, 0.1f, scale.z + 0.05f, 0.025f), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f,1.25f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4(0.04f, 0.1f, (scale.z+0.05f), (scale.w+0.05f)) / 2.f), glm::vec4((scale.x+0.05f)  / 2.f + 0.02f, height+0.05f, 0.f, 0.f) + position, alg::bivec4(), glm::vec4(0.04f, 0.1f, (scale.z+0.05f), (scale.w+0.05f)), 0.f, 1.f, isFrameReflect, framecolor,glm::vec4(1.f,0.75f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4(0.04f, 0.1f, (scale.z+0.05f), (scale.w+0.05f)) / 2.f), glm::vec4(-(scale.x+0.05f) / 2.f - 0.02f, height + 0.05f, 0.f, 0.f) + position, alg::bivec4(), glm::vec4(0.04f, 0.1f, (scale.z+0.05f), (scale.w+0.05f)), 0.f, 1.f, isFrameReflect, framecolor,glm::vec4(1.f,0.75f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4((scale.x+0.05f) + 0.08f, 0.1f, 0.04f, (scale.w+0.05f)) / 2.f), glm::vec4(0.f, height + 0.05f, (scale.z+0.05f) / 2.f + 0.02f, 0.f) + position, alg::bivec4(), glm::vec4((scale.x+0.05f) + 0.08f, 0.1f, 0.04f, (scale.w+0.05f)), 0.f, 1.f, isFrameReflect, framecolor,glm::vec4(1.f,0.75f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4((scale.x+0.05f) + 0.08f, 0.1f, 0.04f, (scale.w+0.05f)) / 2.f), glm::vec4(0.f, height + 0.05f, -(scale.z+0.05f) / 2.f - 0.02f, 0.f) + position, alg::bivec4(), glm::vec4((scale.x+0.05f) + 0.08f, 0.1f, 0.04f, (scale.w+0.05f)), 0.f, 1.f, isFrameReflect, framecolor,glm::vec4(1.f,0.75f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4((scale.x+0.05f) + 0.08f, 0.1f, (scale.z+0.05f) + 0.08f, 0.04f) / 2.f), glm::vec4(0.f, height + 0.05f, 0.f, (scale.w+0.05f) / 2.f + 0.02f) + position, alg::bivec4(), glm::vec4((scale.x+0.05f) + 0.08f, 0.1f, (scale.z+0.05f) + 0.08f, 0.04f), 0.f, 1.f, isFrameReflect, framecolor,glm::vec4(1.f,0.75f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Hypercube(glm::vec4((scale.x+0.05f) + 0.08f, 0.1f, (scale.z+0.05f) + 0.08f, 0.04f) / 2.f), glm::vec4(0.f, height + 0.05f, 0.f, -(scale.w+0.05f) / 2.f - 0.02f) + position, alg::bivec4(), glm::vec4((scale.x+0.05f) + 0.08f, 0.1f, (scale.z+0.05f) + 0.08f, 0.04f), 0.f, 1.f, isFrameReflect, framecolor,glm::vec4(1.f,0.75f,0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), NONE, shaderIndex));

	walls4D->push_back(new Wall4D("Billiard", Noneshape(), glm::vec4(scale.x / 2.f + 0.1f, height + 0.05f, 0.f, 0.f) + position, alg::bivec4(), glm::vec4(0.2f, 0.6f, scale.z, scale.w), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f, 1.25f, 0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Noneshape(), glm::vec4(-scale.x / 2.f - 0.1f, height + 0.05f, 0.f, 0.f) + position, alg::bivec4(), glm::vec4(0.2f, 0.6f, scale.z, scale.w), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f, 1.25f, 0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Noneshape(), glm::vec4(0.f, height + 0.05f, scale.z / 2.f + 0.1f, 0.f) + position, alg::bivec4(), glm::vec4(scale.x + 0.4f, 0.6f, 0.2f, scale.w), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f, 1.25f, 0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Noneshape(), glm::vec4(0.f, height + 0.05f, -scale.z / 2.f - 0.1f, 0.f) + position, alg::bivec4(), glm::vec4(scale.x + 0.4f, 0.6f, 0.2f, scale.w), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f, 1.25f, 0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Noneshape(), glm::vec4(0.f, height + 0.05f, 0.f, scale.w / 2.f + 0.1f) + position, alg::bivec4(), glm::vec4(scale.x + 0.4f, 0.6f, scale.z + 0.4f, 0.2f), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f, 1.25f, 0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, shaderIndex));
	walls4D->push_back(new Wall4D("Billiard", Noneshape(), glm::vec4(0.f, height + 0.05f, 0.f, -scale.w / 2.f - 0.1f) + position, alg::bivec4(), glm::vec4(scale.x + 0.4f, 0.6f, scale.z + 0.4f, 0.2f), 0.f, 1.f, isTopReflect, topTextureIndex,glm::vec4(0.5f, 1.25f, 0.5f,1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, shaderIndex));
