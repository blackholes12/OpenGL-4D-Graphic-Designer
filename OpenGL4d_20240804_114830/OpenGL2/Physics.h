		...
		for (size_t i(0); i < this->emitters4D.size(); i++) {
			...
			if (this->emitters4D[i]->type == 0)
			{
				...
				if (emitTime00 / (float)emitCount00 >= 1.f / 60.f)
				{
					...
					{
						this->emitters4D[i]->particles4D.push_back(new Particle4D0(PARTICLE2, this->emitters4D[i]->position4D, 8.f * normalize(glm::vec4(rand() % 100 - 50, rand() % 160, rand() % 100 - 50, 0.f)), 1.f, 1.f, glm::vec4(1.f, 0.f, 0.f, 1.f), glm::vec4(1.f, 0.f, 0.f, 1.f), true, 1.f, 1.f, 0.5f, 1.f, 1, 0));
				...
				if (this->emitters4D[i]->time == 0.f)
				{
					...
					for (int k(0); k < 4; k++)
					{
						this->emitters4D[i]->particles4D.push_back(new Particle4D0(PARTICLE3, this->emitters4D[i]->position4D + (float)(rand() % 3 + 5) / 17.5f * normalize(glm::vec4(rand() % 100 - 50))
