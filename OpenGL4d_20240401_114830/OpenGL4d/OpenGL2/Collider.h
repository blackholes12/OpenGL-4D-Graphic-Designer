			...
			if (find_dynamite4d(this->dynamites4D, this->dynamites4D2, i)->objectName == "Exploding Dynamite")
			{
				for (size_t j = 0; j < size_of_objects4d(this->rigidBodies4D,this->dynamites4D2); j++)
				{
					if (length(find_rigidbody4d(this->rigidBodies4D, this->dynamites4D2, j)->position4D - find_dynamite4d(this->dynamites4D, this->dynamites4D2, i)->position4D) < 10.f)
					{
						...
						find_rigidbody4d(this->rigidBodies4D, this->dynamites4D2, j)->forceSystems4D.push_back(new ForceSystem4D(2.2857f * 3000.f * normalize(find_rigidbody4d(this->rigidBodies4D, this->dynamites4D2, j)->position4D - find_dynamite4d(this->dynamites4D, this->dynamites4D2, i)->position4D) / (distance * distance * distance), glm::vec4(0.f)));
					}
				}
				...
				this->emitters4D.push_back(new Emitter4D(0,find_dynamite4d(this->dynamites4D, this->dynamites4D2, i)->position4D,
					get_dynamite4d_velocity(this->dynamites4D, this->dynamites4D2, i),
					10.f));
