...
public:
	...
	void fit_direction(const int direction)
	{
		switch (direction)
		{
		case 0:set_rotation4D(alg::bivec4(0.f, this->Rotate_Angle4D.xz, 90.f, this->Rotate_Angle4D.yz,0.f,0.f));break;
		case 1:set_rotation4D(alg::bivec4(0.f, this->Rotate_Angle4D.xz, 0.f, this->Rotate_Angle4D.yz, 90.f, 0.f));break;
		case 2:set_rotation4D(alg::bivec4(0.f, this->Rotate_Angle4D.xz, 0.f, this->Rotate_Angle4D.yz, 0.f, 90.f));break;
		case 3:set_rotation4D(alg::bivec4(0.f, this->Rotate_Angle4D.xz, 0.f, this->Rotate_Angle4D.yz, 0.f, 0.f));break;
		default:break;
		}
	}
	...
	void move(const float dt,const int direction4Dection,RigidBody4D* player)
	{
		...
		case FORWARD:
			...
			{
				this->direction4D = glm::vec4(0, this->Rotate_Angle4D.yz / 10000.f, -1.f, 0) * viewMat4D;
			}
			else
			{
		...
		case ANA:
			...
			{
				this->direction4D = glm::vec4(0, this->Rotate_Angle4D.yz / 10000.f, 0, -1.f) * viewMat4D;
			}
			else
			{
