...
void Game::startObjects(int level,const char* filePath)
{
	...
	if (filePath == "")
	{
		...
		case 1:
		{
			...
			this->walls4D.push_back(new Wall4D("Hypercube", Hypercube(glm::vec4(6.4f, 0.1f, 0.01f, 3.f) / 2.f), glm::vec4(-7.3f, 64.05f, -1.495f, 0.f), alg::bivec4(), glm::vec4(6.4f, 0.1f, 0.01f, 3.f), 1.265f, 0.f, true, this->wallTexs3D[WHITEWALL], 0.f, glm::vec4(0.f, 0.f, 0.f, 1.f), NONE, this->shaders[WALLD4]));
			...
			generate_room4D(glm::vec4(-12.f, 64.f, -1001.5f, 0.f), glm::vec4(3.f, 3.f, 2000.f, 3.f), 1, 3, 0, 0, 0, 0, true, this->wallTexs3D[GROUND], glm::vec4(1), this->shaders[WALLD4], true, this->wallTexs3D[GROUND], glm::vec4(0.f, 0.f, 0.f, 1.f), this->shaders[WALLD4], false, this->wallTexs3D[WHITEWALL], glm::vec4(1.f), this->shaders[WALLD4], false, this->wallTexs3D[CEIL2], glm::vec4(1), this->shaders[WALLD4], &this->walls4D);
			...
			generate_room4D(glm::vec4(-7.3f, 64.f, -7.7f, 0.f), glm::vec4(6.f, 3.f, 12.f, 8.f), 4, 5, 0, 0, 0, 0, true, this->wallTexs3D[GROUND], glm::vec4(1), this->shaders[WALLD4], true, this->wallTexs3D[GROUND], glm::vec4(0.f, 0.f, 0.f, 1.f), this->shaders[WALLD4], false, this->wallTexs3D[WHITEWALL], glm::vec4(1.f), this->shaders[WALLD4], false, this->wallTexs3D[CEIL2], glm::vec4(1.f), this->shaders[WALLD4], &this->walls4D);
