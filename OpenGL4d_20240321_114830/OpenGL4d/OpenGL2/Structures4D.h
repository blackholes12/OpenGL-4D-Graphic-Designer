...
{
	rigidBodies4D->push_back(new RigidBody4D("Billiard", Hypersphere(glm::vec4(0.0525f)), position, alg::bivec4(30, 30, 30, 30, 30, 30), glm::vec4(0.0525f), 0.25f, 0.000675f, 0.f, 1.f, isGravity,false, velocity4D, angularVelocity, true, texture, metal, color, SPHERE4D, true, shader));
}
...
{
	dynamites4D->push_back(new RigidBody4D("Dynamite", Hypercylinder(glm::vec4(0.2f, 0.2f, 1.f, 0.2f) / 2.f), position + glm::vec4(0.f, 0.5f, 0.f, 0.f), alg::bivec4(0.f, 0.f, 0.f, 90.f), glm::vec4(0.2f, 0.2f, 1.f, 0.2f), 1.f, 0.1f, 1.6f, 0.25f, isGravity, false, velocity4D, angularVelocity, true, texture,0.f, glm::vec4(0.77f, 0.3f, 0.2f,0.5f) * 2.f, BOX4D,true, shader));
}
