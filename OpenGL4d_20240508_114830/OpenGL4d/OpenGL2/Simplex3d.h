...
static float simplex3d(glm::vec3 p) {
	 ...
	 glm::vec3 i2 = glm::vec3(1.0) - glm::vec3(e.z,e.x,e.y)*(glm::vec3(1.0) - e);
	 ...
	 w = max(glm::vec4(0.6f) - w, glm::vec4(0.0f));
	 
	 /* calculate surflet components */
	 d.x = dot(random3(s), x);
	 d.y = dot(random3(s + i1), x1);
	 d.z = dot(random3(s + i2), x2);
	 d.w = dot(random3(s + glm::vec3(1.0f)), x3);
	 ...
	 return dot(d, glm::vec4(52.0));
}

/* const matrices for 3d rotation */
static const glm::mat3 rot1 = glm::mat3(-0.37f, 0.36f, 0.85f,-0.14f,-0.93f, 0.34f,0.92f, 0.01f,0.4f);
static const glm::mat3 rot2 = glm::mat3(-0.55f,-0.39f, 0.74f, 0.33f,-0.91f,-0.24f,0.77f, 0.12f,0.63f);
static const glm::mat3 rot3 = glm::mat3(-0.71f, 0.52f,-0.47f,-0.08f,-0.72f,-0.68f,-0.7f,-0.45f,0.56f);
