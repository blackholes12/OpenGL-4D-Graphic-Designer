...
static std::vector<Group*> pack_group(std::vector<Group*> groups, std::vector<Wall4D*>* walls4D, std::vector<Terrain4D*>* terrains4D, std::vector<PointLight4D*>* pointLights4D)
{
	...
	//}
	return groups;
	for (Group* i : groups) { free(i), i = nullptr; }
}