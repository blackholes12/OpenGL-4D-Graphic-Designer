...
public:
	...
	void transform_vertex4D(glm::vec4* points4D, const unsigned int sizeOfpoints4D, glm::vec4* normal4d, glm::ivec2* indices4D0, const unsigned int sizeOfTetra, Vertex4D* vertices4d, GLuint* indices4d, glm::vec4 scale4D,unsigned int texType) {
		...
		for (unsigned j = 0; j < sizeOfTetra; j++) {
			...
			if (texType == 0)
			{
				texcoord_A = texcoord_position(normalAverage, point_A * scale4D);
				texcoord_B = texcoord_position(normalAverage, point_B * scale4D);
				texcoord_C = texcoord_position(normalAverage, point_C * scale4D);
				texcoord_D = texcoord_position(normalAverage, point_D * scale4D);
			}
			else if (texType == 1)
			{
				texcoord_A = texcoord_position2(normalAverage, point_A * scale4D);
				texcoord_B = texcoord_position2(normalAverage, point_B * scale4D);
				texcoord_C = texcoord_position2(normalAverage, point_C * scale4D);
				texcoord_D = texcoord_position2(normalAverage, point_D * scale4D);
			}
	...
	void transform_terrain4D(glm::vec4* points4D, glm::vec4* normal4d, glm::ivec3* cubeIndex_XZW,unsigned int* indices4D0,glm::vec4 offset4d, const unsigned int sizeOfTetra, Vertex4D* vertices4d, GLuint* indices4d) {
		...
		for (unsigned j = 0;j < sizeOfTetra;j++) {
			...
			glm::vec3 texcoord_A = texcoord_position2(point_A + offset4d);
			glm::vec3 texcoord_B = texcoord_position2(point_B + offset4d);
			glm::vec3 texcoord_C = texcoord_position2(point_C + offset4d);
			glm::vec3 texcoord_D = texcoord_position2(point_D + offset4d);
...
public:
	Noneshape(): Primitive4D()
	{
		...
		this->transform_vertex4D(new glm::vec4[0], 0, new glm::vec4[0], new glm::ivec2[0], 0, new Vertex4D[0], new GLuint[0], glm::vec4(1.f),0);
	}
	~Noneshape() {
...
public:
	TriPrism(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(triPrism::vertices4D, sizeof(triPrism::vertices4D) / sizeof(glm::vec4), triPrism::normals4D, triPrism::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,0);
	}
	~TriPrism() {
...
public:
	Hyperslope(glm::vec4 scale4D) : Primitive4D()
	{
		...
		this->transform_vertex4D(hyperslope::vertices4D, sizeof(hyperslope::vertices4D) / sizeof(glm::vec4), hyperslope::normals4D,hyperslope::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,0);
	}
	~Hyperslope() {
...
public:
	Hypersphere(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(hypersphere::vertices4D, sizeof(hypersphere::vertices4D) / sizeof(glm::vec4), hypersphere::normals4D, hypersphere::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,1);
	}
	~Hypersphere() {	
	}
};
...
public:
	Hyperspherecol(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(hyperspherecol::vertices4D, sizeof(hyperspherecol::vertices4D) / sizeof(glm::vec4), hyperspherecol::normals4D, hyperspherecol::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,1);
	}
	~Hyperspherecol() {
	}
};
...
public:
	Hypercapsule(glm::vec4 scale4D): Primitive4D()
	{
		...
		for (int i = 0; i < sizeOfPoints; i++){
			...
			float height = 2.f*point4D.z;
			if (height > 0.f){height = glm::mix(1.f - 2.f * radious / capsuleLength, 1.f, height);}
			if (height < 0.f){height = -glm::mix(1.f - 2.f * radious / capsuleLength, 1.f, -height);}
			this->points4D[i] = glm::vec4(point4D.x, point4D.y, height/2.f, point4D.w);
			this->normals4D[i] = normalize(glm::vec4(point4D.x, point4D.y, point4D.z / (2.f * radious / capsuleLength), point4D.w));
		}
		this->transform_vertex4D(this->points4D, sizeOfPoints, this->normals4D, hypersphere::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,1);
	}
	~Hypercapsule() {
...
public:
	Hypercylinder(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(hypercylinder::vertices4D, sizeof(hypercylinder::vertices4D) / sizeof(glm::vec4), hypercylinder::normals4D, hypercylinder::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,1);
	}
	~Hypercylinder() {
	}
};
...
public:
	Hypercone(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(hypercone::vertices4D, sizeof(hypercone::vertices4D) / sizeof(glm::vec4), hypercone::normals4D, hypercone::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,1);
	}
	~Hypercone() {
	}
};
...
public:
	Hyperpot(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(hyperpot::vertices4D, sizeof(hyperpot::vertices4D) / sizeof(glm::vec4), hyperpot::normals4D, hyperpot::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,1);
	}
	~Hyperpot() {
	}
};
...
public:
	Hypercube(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(hypercube::vertices4D, sizeof(hypercube::vertices4D) / sizeof(glm::vec4), hypercube::normals4D,hypercube::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,0);
	}
	~Hypercube() {
...
public:
	Quad4d(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(quad4d::vertices4D, sizeof(quad4d::vertices4D) / sizeof(glm::vec4), quad4d::normals4D, quad4d::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,0);
	}
	~Quad4d() {
...
public:
	Particle4d(): Primitive4D()
	{
		...
		const unsigned int sizeOfTetra = sizeof(quad4d::indices4D0) / sizeof(glm::ivec2) / 4;
		this->transform_vertex4D(quad4d::vertices4D, sizeof(quad4d::vertices4D) / sizeof(glm::vec4), quad4d::normals4D, quad4d::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], glm::vec4(1.f),0);
	}
	~Particle4d() {
...
public:
	DoubleQuads4d(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(doublequads4d::vertices4D,sizeof(doublequads4d::vertices4D) / sizeof(glm::vec4), doublequads4d::normals4D,doublequads4d::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,0);
	}
	~DoubleQuads4d() {
...
public:
	Box4d(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(box4d::vertices4D,sizeof(box4d::vertices4D) / sizeof(glm::vec4), box4d::normals4D,box4d::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,0);
	}
	~Box4d() {
...
public:
	Waterbox4d(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(waterbox4d::vertices4D,sizeof(waterbox4d::vertices4D) / sizeof(glm::vec4), waterbox4d::normals4D ,waterbox4d::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,0);
	}
	~Waterbox4d() {
...
public:
	Pentachoron(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(pentachoron::vertices4D,sizeof(pentachoron::vertices4D) / sizeof(glm::vec4), pentachoron::normals4D,pentachoron::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra],scale4D,0);
	}
	~Pentachoron() {
...
public:
	Pyramid4D(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(pyramid4d::vertices4D, sizeof(pyramid4d::vertices4D) / sizeof(glm::vec4), pyramid4d::normals4D, pyramid4d::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,0);
	}
	~Pyramid4D() {
...
public:
	Hexadecachoron(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(hexadecachoron::vertices4D, sizeof(hexadecachoron::vertices4D) / sizeof(glm::vec4), hexadecachoron::normals4D,hexadecachoron::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,0);
	}
	~Hexadecachoron() {
...
public:
	Hexacosichoron(glm::vec4 scale4D): Primitive4D()
	{
		...
		this->transform_vertex4D(hexacosichoron::vertices4D, sizeof(hexacosichoron::vertices4D) / sizeof(glm::vec4), hexacosichoron::normals4D,hexacosichoron::indices4D0, sizeOfTetra, new Vertex4D[4 * sizeOfTetra], new GLuint[6 * sizeOfTetra], scale4D,0);
	}
	~Hexacosichoron() {
...
public:
	...
	~Terrain4d() {
		delete[] this->terrainHeight2,this->terrainHeight2 = nullptr;
		delete[] this->terrainNormal2,this->terrainNormal2 = nullptr;
		delete[] this->coordinate_XZW,this->coordinate_XZW = nullptr;
		delete[] this->cubeIndex_XZW,this->cubeIndex_XZW = nullptr;
		delete[] this->points4D,this->points4D = nullptr;
		delete[] this->normals4D2,this->normals4D2 = nullptr;
		delete[] this->indices4D0,this->indices4D0 = nullptr;
