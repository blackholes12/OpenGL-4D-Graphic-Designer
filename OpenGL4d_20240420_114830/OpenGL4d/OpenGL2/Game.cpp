...
void Game::startDemos()
{
	...
	generate_billiard4D(glm::vec4(0.f), glm::vec4(),alg::bivec4(),this->wallTexs3D[this->buildTexture], &billiard4D, this->isGravity, 0.f,glm::vec4(1.f),false,this->shaders[DEMOD4]);
	...
	generate_dynamite4D(glm::vec4(0.f), this->initialVelocity, this->initialAngularVelocity, this->wallTexs3D[WHITECONCRETE], &dynamite4D2, this->isGravity,false, this->shaders[DEMOD4]);
