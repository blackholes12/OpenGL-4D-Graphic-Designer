			...
			if (this->inputs[2]->getMouseOnPress(this->window, GLFW_MOUSE_BUTTON_2))
			{
				if (this->isFindPoint) {
					...
					if (this->buildMode == BUILD_RIGIDBODY)
					{
						...
						switch (this->buildCol)
						{
						case HYPERCUBE:this->rigidBodies4D.push_back(new RigidBody4D(this->buildTag, Hypercube(this->buildScale / 2.f), this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f - 0.01f, 0.f, 0.f), this->buildRotation, this->buildScale,this->buildParameter.x, this->buildParameter.y, this->buildParameter.z, this->buildParameter.w,this->isGravity, false, this->initialVelocity, this->initialAngularVelocity, this->isSpecular, this->wallTexs3D[this->buildTexture], this->metal, this->buildColor, BOX4D, true, this->shaders[this->buildShader]));break;
						case HYPERSPHERE:this->rigidBodies4D.push_back(new RigidBody4D(this->buildTag, Hypersphere(this->buildScale / 2.f), this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f - 0.01f, 0.f, 0.f), this->buildRotation, this->buildScale,this->buildParameter.x, this->buildParameter.y, this->buildParameter.z, this->buildParameter.w,this->isGravity, false, this->initialVelocity, this->initialAngularVelocity, this->isSpecular, this->wallTexs3D[this->buildTexture], this->metal, this->buildColor, SPHERE4D, true, this->shaders[this->buildShader])); break;
						case HYPERCAPSULE:this->rigidBodies4D.push_back(new RigidBody4D(this->buildTag, Hypercapsule(this->buildScale / 2.f), this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f - 0.01f, 0.f, 0.f), this->buildRotation, this->buildScale,this->buildParameter.x, this->buildParameter.y, this->buildParameter.z, this->buildParameter.w,this->isGravity, false, this->initialVelocity, this->initialAngularVelocity, this->isSpecular, this->wallTexs3D[this->buildTexture], this->metal, this->buildColor, CAPSULE4D, true, this->shaders[this->buildShader])); break;
						case HYPERCYLINDER:this->rigidBodies4D.push_back(new RigidBody4D(this->buildTag, Hypercylinder(this->buildScale / 2.f), this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f - 0.01f, 0.f, 0.f), this->buildRotation, this->buildScale, this->buildParameter.x, this->buildParameter.y, this->buildParameter.z, this->buildParameter.w, this->isGravity, false, this->initialVelocity, this->initialAngularVelocity, this->isSpecular, this->wallTexs3D[this->buildTexture], this->metal, this->buildColor, MESH4D, true, this->shaders[this->buildShader])); break;
						case HYPERCONE:this->rigidBodies4D.push_back(new RigidBody4D(this->buildTag, Hypercone(this->buildScale / 2.f), this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f - 0.01f, 0.f, 0.f), this->buildRotation, this->buildScale,this->buildParameter.x, this->buildParameter.y, this->buildParameter.z, this->buildParameter.w,this->isGravity, false, this->initialVelocity, this->initialAngularVelocity, this->isSpecular, this->wallTexs3D[this->buildTexture], this->metal, this->buildColor, MESH4D, true, this->shaders[this->buildShader]));break;
						case HYPERPOT:this->rigidBodies4D.push_back(new RigidBody4D(this->buildTag, Hyperpot(this->buildScale / 2.f), this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f - 0.01f, 0.f, 0.f), this->buildRotation, this->buildScale,this->buildParameter.x, this->buildParameter.y, this->buildParameter.z, this->buildParameter.w,this->isGravity, false, this->initialVelocity, this->initialAngularVelocity, this->isSpecular, this->wallTexs3D[this->buildTexture], this->metal, this->buildColor, MESH4D, true, this->shaders[this->buildShader]));break;
						case TRIPRISM:this->rigidBodies4D.push_back(new RigidBody4D(this->buildTag, TriPrism(this->buildScale / 2.f), this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f - 0.01f, 0.f, 0.f), this->buildRotation, this->buildScale,this->buildParameter.x, this->buildParameter.y, this->buildParameter.z, this->buildParameter.w,this->isGravity, false, this->initialVelocity, this->initialAngularVelocity, this->isSpecular, this->wallTexs3D[this->buildTexture], this->metal, this->buildColor, MESH4D, true, this->shaders[this->buildShader]));break;
						case HYPERSLOPE:this->rigidBodies4D.push_back(new RigidBody4D(this->buildTag, Hyperslope(this->buildScale / 2.f), this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f - 0.01f, 0.f, 0.f), this->buildRotation, this->buildScale,this->buildParameter.x, this->buildParameter.y, this->buildParameter.z, this->buildParameter.w,this->isGravity, false, this->initialVelocity, this->initialAngularVelocity, this->isSpecular, this->wallTexs3D[this->buildTexture], this->metal, this->buildColor, MESH4D, true, this->shaders[this->buildShader]));break;
						case HYPERQUAD:this->rigidBodies4D.push_back(new RigidBody4D(this->buildTag, DoubleQuads4d(this->buildScale / 2.f), this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f - 0.01f, 0.f, 0.f), this->buildRotation, this->buildScale,this->buildParameter.x, this->buildParameter.y, this->buildParameter.z, this->buildParameter.w,this->isGravity, false, this->initialVelocity, this->initialAngularVelocity, this->isSpecular, this->wallTexs3D[this->buildTexture], this->metal, this->buildColor, MESH4D, true, this->shaders[this->buildShader]));break;
						case PENTACHORON:this->rigidBodies4D.push_back(new RigidBody4D(this->buildTag, Pentachoron(this->buildScale / 2.f), this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f - 0.01f, 0.f, 0.f), this->buildRotation, this->buildScale,this->buildParameter.x, this->buildParameter.y, this->buildParameter.z, this->buildParameter.w,this->isGravity, false, this->initialVelocity, this->initialAngularVelocity, this->isSpecular, this->wallTexs3D[this->buildTexture], this->metal, this->buildColor, MESH4D, true, this->shaders[this->buildShader]));break;
						case HYPERPYRAMID:this->rigidBodies4D.push_back(new RigidBody4D(this->buildTag, Pyramid4D(this->buildScale / 2.f), this->hittingPos4D + glm::vec4(0.f, this->buildScale.y / 2.f - 0.01f, 0.f, 0.f), this->buildRotation, this->buildScale,this->buildParameter.x, this->buildParameter.y, this->buildParameter.z, this->buildParameter.w,this->isGravity, false, this->initialVelocity, this->initialAngularVelocity, this->isSpecular, this->wallTexs3D[this->buildTexture], this->metal, this->buildColor, MESH4D, true, this->shaders[this->buildShader]));break;
					...
					if (this->buildMode == BUILD_BILLIARD)
					{
						shift_animation4D(this->shifts4D, this->floats4D, this->rotates4D, this->rigidBodies4D.size(), 1);
						shift_joint4d(this->sticks4D, this->springs4D, this->hingeConstraints, this->rigidBodies4D.size(), 1);
						generate_billiard4D(this->hittingPos4D + glm::vec4(0.f, 0.0525f/2.f - 0.01f, 0.f, 0.f),this->initialVelocity,this->initialAngularVelocity, this->wallTexs3D[this->buildTexture], &this->rigidBodies4D, this->isGravity,this->metal,this->buildColor, this->shaders[this->buildShader]);
					}
					if (this->buildMode == BUILD_DYNAMITE)
					{
						...
						if (this->isRigidBody)
						{
							...
							generate_dynamite4D(this->hittingPos4D + glm::vec4(0, -0.01f, 0, 0), this->initialVelocity,this->initialAngularVelocity,this->wallTexs3D[WHITECONCRETE], &this->dynamites4D2, this->isGravity, this->shaders[this->buildShader]);
						}
					}
				}
