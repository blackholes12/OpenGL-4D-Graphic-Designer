	...
	if (!this->curserMode){
		...
		if (this->mode == BUILDING) {
			...
			if (this->inputs[2]->getMouseOnPress(this->window, GLFW_MOUSE_BUTTON_2))
			{
						...
						if (this->hitIndex.n < size_of_objects4d(this->rigidBodies4D, this->walls4D))
						{
							...
							if (o->objectName != "Ground")
							{
								...
								if (isInitial)
								{
									...
									if (size == 0)
									{
										this->sticks4D.push_back(new Stick4D(glm::vec4(0.f), this->hitIndex.n, VectorIndex(0, false), this->stickLength, WHITECONCRETE, this->buildColor, this->buildShader));
							...
							if (this->hitIndex.n < size_of_objects4d(this->rigidBodies4D, this->walls4D))
							{
								...
								if (o->objectName != "Ground")
								{
									...
									if (isInitial)
									{
										...
										if (size == 0)
										{
											this->springs4D.push_back(new Spring4D(glm::vec4(0.f), this->hitIndex.n, VectorIndex(0, false), this->springLength, this->springStrength, STONE, this->buildColor, this->buildShader));
				...
				if(sizeOfGroups!=this->groups.size())this->groupIndices = judge_groups(this->rigidBodies4D, this->groupIndices, this->groups, this->camera.position4D, this->blockLoadDistance);
