	...
	else
	{
		...
		while (std::getline(in_file, line2))
		{
			...
			case 4: {
				...
				break; }
			case 5: { 
				glm::vec4 fixPoint4D; size_t index1; VectorIndex index2(VectorIndex(0,false)); float stickLength; size_t texture3DIndex; glm::vec4 paintingColor; size_t shaderIndex;
				...
				break; }
			case 6: { 
				glm::vec4 fixPoint4D; size_t index1; VectorIndex index2(VectorIndex(0, false)); float springLength; float k; size_t texture3DIndex; glm::vec4 paintingColor; size_t shaderIndex;
			...
			case 8: { 
				...
				break; }
			case 9: { 
				glm::vec4 position4D; glm::vec4 bodyPosition4D; alg::rotor4 rotation4D; alg::bivec4 angularVelocity4D; bool isPositionFixed; size_t index1; VectorIndex index2(VectorIndex(0,false));
			...
			case 11: { 
				size_t size; glm::vec4 worldPosition4D; glm::vec4 bodyPosition4D1; glm::vec4 bodyPosition4D2; size_t index1; VectorIndex index2(VectorIndex(0, false));
				ss2 >> size;
