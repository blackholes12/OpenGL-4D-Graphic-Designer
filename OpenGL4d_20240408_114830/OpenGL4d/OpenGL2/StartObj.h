...
void Game::startObjects(int level,unsigned type,const char* filePath)
{
	if (type == 0)
	{
		...
		{
		case 1:
			this->rigidBodies4D.push_back(new RigidBody4D("Player", Hypercapsule(glm::vec4(0.4f, 0.4f, 1.4f, 0.4f)), glm::vec4(0.f, 64.7f, 0.f, 0.f), alg::bivec4(0.f, 0.f, 0.f, 90.f), glm::vec4(0.4f, 0.4f, 1.4f, 0.4f), 65.f, 0.f, 1.265f, 0.25f, true, false, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[PURE_WHITE], 0.f, glm::vec4(1.f, 1.f, 1.f, 0.25f), CAPSULE4D, true, this->shaders[WALLD4]));
			this->walls4D.push_back(new Wall4D("Glass4D", Hypersphere(glm::vec4(0.5f)), glm::vec4(-5.f, 66.4f, 0.f, 0), alg::bivec4(), glm::vec4(0.5f), 1.265f, 1.f, true, this->wallTexs3D[PURE_HARFRED_GREEN], 0.25f, glm::vec4(1.f), SPHERE4D, this->shaders[WALLD4]));
			for (int i = 0; i < 11; i++)
			{
				this->walls4D.push_back(new Wall4D("LED4D", Hypercylinder(glm::vec4(0.36f, 0.36f, 0.025f, 0.36f)), glm::vec4(14 * i - 14 * 5, 66.7875f, 0.f, 0.f), alg::bivec4(0, 0, 0, 90), glm::vec4(0.36f, 0.36f, 0.025f, 0.36f), 1.265f, 1.f, false, this->wallTexs3D[PURE_WHITE], 0.f, glm::vec4(1.f), NONE, this->shaders[EMITD4]));
			}
			...
			this->rigidBodies4D.push_back(new RigidBody4D("Hypersphere", Hypersphere(glm::vec4(0.5f)), glm::vec4(-8.f, 66.4f, 0.f, 0), alg::bivec4(), glm::vec4(0.5f), 1.f, 0.5f, 1.265f, 1.f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[PURE_RED_GREEN], 0.25f, glm::vec4(1.f), SPHERE4D, true, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypersphere", Hypersphere(glm::vec4(0.5f)), glm::vec4(-11.f, 66.4f, 0.f, 0), alg::bivec4(), glm::vec4(0.5f), 1.f, 0.5f, 1.265f, 1.f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[PURE_RED_HARFGREEN], 0.25f, glm::vec4(1.f), SPHERE4D, true, this->shaders[WALLD4]));
			...
			this->walls4D.push_back(new Wall4D("Glass4D", Hypercube(glm::vec4(0.7f, 1.f, 0.7f, 0.7f) / 2.f), glm::vec4(-2.f, 64.5f, 0.f, 0.f), alg::bivec4(), glm::vec4(0.7f, 1.f, 0.7f, 0.7f), 1.265f, 1.f, true, this->wallTexs3D[CHESSBOARDMARBLE], 0.f, glm::vec4(1.f), BOX4D, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Glass4D", Hexacosichoron(glm::vec4(0.707106781186547f)), glm::vec4(-2.f, 65.7f, 0.f, 0.f), alg::bivec4(), glm::vec4(0.5f), 65.f, 0.f, 1.265f, 0.25f, false, false, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[GLASS], 0.75f, glm::vec4(1.1f, 1.5f, 0.f, 2.f), MESH4D, false, this->shaders[WALLD4]));
			...
			this->walls4D.push_back(new Wall4D("Pentatope", Pentachoron(glm::vec4(1) / 2.f), glm::vec4(2.5f, 64.5f, 0, 0), alg::bivec4(), glm::vec4(1), 1.265f, 0.25f, true, this->wallTexs3D[CHESSBOARDMARBLE], 0.f, glm::vec4(1.f), MESH4D, this->shaders[WALLD4]));
			this->walls4D.push_back(new Wall4D("Pyramid4D", Pyramid4D(glm::vec4(1) / 2.f), glm::vec4(4.5f, 64.5f, 0, 0), alg::bivec4(), glm::vec4(1), 1.265f, 0.25f, true, this->wallTexs3D[CHESSBOARDMARBLE], 0.f, glm::vec4(1.f), MESH4D, this->shaders[WALLD4]));
			this->walls4D.push_back(new Wall4D("TriPrism", TriPrism(glm::vec4(1) / 2.f), glm::vec4(6.5f, 64.5f, 0, 0), alg::bivec4(), glm::vec4(1), 1.265f, 0.25f, true, this->wallTexs3D[CHESSBOARDMARBLE], 0.f, glm::vec4(1.f), MESH4D, this->shaders[WALLD4]));
			this->walls4D.push_back(new Wall4D("Hypercone", Hypercylinder(glm::vec4(1) / 2.f), glm::vec4(8.5f, 64.5f, 0, 0), alg::bivec4(), glm::vec4(1), 1.265f, 0.25f, true, this->wallTexs3D[CHESSBOARDMARBLE], 0.f, glm::vec4(1.f), MESH4D, this->shaders[WALLD4]));
		...
		case 2:
			...
			this->walls4D.push_back(new Wall4D("Hypersphere", Hypersphere(glm::vec4(0.5f)), glm::vec4(3.95f, 64.35f, 0.f, 0.45f), alg::bivec4(), glm::vec4(0.5f), 1.265f, 0.f, true, this->wallTexs3D[PURE_RED_GREEN], 0.25f, glm::vec4(1.f), SPHERE4D, this->shaders[WALLD4]));
			this->walls4D.push_back(new Wall4D("Hypersphere", Hypersphere(glm::vec4(0.5f)), glm::vec4(3.05f, 64.35f, 0.f, 0.45f), alg::bivec4(), glm::vec4(0.5f), 1.265f, 0.f, true, this->wallTexs3D[PURE_RED_GREEN], 0.25f, glm::vec4(1.f), SPHERE4D, this->shaders[WALLD4]));
			this->walls4D.push_back(new Wall4D("Hypersphere", Hypersphere(glm::vec4(0.5f)), glm::vec4(3.95f, 64.35f, 0.f, -0.45f), alg::bivec4(), glm::vec4(0.5f), 1.265f, 0.f, true, this->wallTexs3D[PURE_RED_GREEN], 0.25f, glm::vec4(1.f), SPHERE4D, this->shaders[WALLD4]));
			this->walls4D.push_back(new Wall4D("Hypersphere", Hypersphere(glm::vec4(0.5f)), glm::vec4(3.05f, 64.35f, 0.f, -0.45f), alg::bivec4(), glm::vec4(0.5f), 1.265f, 0.f, true, this->wallTexs3D[PURE_RED_GREEN], 0.25f, glm::vec4(1.f), SPHERE4D, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercube", Hypercube(glm::vec4(1.5f, 1.f, 6.f, 1.5f) / 2.f), glm::vec4(3.5f, 65.1f, 0.5f, 0.f), alg::bivec4(), glm::vec4(1.5f, 1.f, 6.f, 1.5f), 3.f, 4.5f, 1.265f, 0.25f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[WOODY], 0.f, glm::vec4(1.f), BOX4D, true, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercube", Hypercube(glm::vec4(0.5f) / 2.f), glm::vec4(3.5f, 65.85f, 2.f, 0.f), alg::bivec4(), glm::vec4(0.5f), 1.f, 0.33f, 1.265f, 0.25f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[PURE_RED], 0.f, glm::vec4(1.f), BOX4D, true, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercube", Hypercube(glm::vec4(0.5f) / 2.f), glm::vec4(3.5f, 67.85f, -1.25f, 0.f), alg::bivec4(), glm::vec4(0.5f), 1.5f, 0.5f, 1.265f, 0.25f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[WHITECONCRETE], 0.5f, glm::vec4(1.f), BOX4D, true, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercube", Hypercube(glm::vec4(0.5f) / 2.f), glm::vec4(3.5f, 67.85f, -1.75f, 0.f), alg::bivec4(), glm::vec4(0.5f), 1.5f, 0.5f, 1.265f, 0.25f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[WHITECONCRETE], 0.5f, glm::vec4(1.f), BOX4D, true, this->shaders[WALLD4]));
		...
		case 5:
			...
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercube", Hypercube(glm::vec4(1.f, 1.f, 1.f, 1.f) / 2.f), glm::vec4(1.5f, 110.6f, -10.f, 0.f), alg::bivec4(), glm::vec4(1.f, 1.f, 1.f, 1.f), 10.f, 5.f, 1.265f, 0.25f, true, true, glm::vec4(0, -35.f, 0, 0), alg::bivec4(), true, this->wallTexs3D[WOODY], 0.f, glm::vec4(1.f), BOX4D, true, this->shaders[WALLD4]));
			...
			this->walls4D.push_back(new Wall4D("Ground", Hypercube(glm::vec4(400.f, 17.f, 400.f, 400.f) / 2.f), glm::vec4(0, 56.f, 0, 0), alg::bivec4(), glm::vec4(400.f, 16.f, 400.f, 400.f), 1.265f, 0.25f, false, this->wallTexs3D[GRASS], 0.f, glm::vec4(1.f), BOX4D, this->shaders[WALLD4]));
		...
		case 6:
			...
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercube", Hypercube(glm::vec4(0.5f)), glm::vec4(-10.3f, 63.9f, 0.f, 0.f), alg::bivec4(), glm::vec4(10.f, 0.2f, 1.f, 1.f), 65.f, 0.f, 1.265f, 0.25f, false, false, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[PURE_WHITE], 0.f, glm::vec4(1.f, 1.f, 0.f, 1.f), BOX4D, false, this->shaders[WALLD4]));
			...
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercone", Hypercone(glm::vec4(0.5f)), glm::vec4(-12.3f, 3.9f, 0.f, 0.f), alg::bivec4(), glm::vec4(1.f), 1.f, 1.f, 1.265f, 0.25f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[PURE_WHITE], 0.f, glm::vec4(1.f, 1.f, 0.f, 1.f), MESH4D, false, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypercylinder", Hypercylinder(glm::vec4(0.5f)), glm::vec4(-12.3f, 3.9f, 2.f, 0.f), alg::bivec4(), glm::vec4(1.f), 1.f, 1.f, 1.265f, 0.25f, true, true, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[PURE_WHITE], 0.f, glm::vec4(1.f, 1.f, 0.f, 1.f), MESH4D, false, this->shaders[WALLD4]));
			this->rigidBodies4D.push_back(new RigidBody4D("Hypersphere", Hypersphere(glm::vec4(0.5f)), glm::vec4(-10.3f, 3.9f, 4.f, 0.f), alg::bivec4(), glm::vec4(1.f), 1.f, 1.f, 1.265f, 0.25f, true, false, glm::vec4(0, 0, 0, 0), alg::bivec4(), true, this->wallTexs3D[PURE_WHITE], 0.f, glm::vec4(1.f, 1.f, 0.f, 1.f), SPHERE4D, false, this->shaders[WALLD4]));
