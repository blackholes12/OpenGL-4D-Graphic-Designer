...
namespace ImGui
{
    ...
    IMGUI_API bool          BlackBodyDragFloat(const char* label, ImTextureID texture_id, float* v, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // If v_min >= v_max we have no bound
    ...
    IMGUI_API bool          BlackBodyDragScalar(const char* label, ImTextureID texture_id, ImGuiDataType data_type, void* p_data, const void* p_min = NULL, const void* p_max = NULL, const char* format = NULL, ImGuiSliderFlags flags = 0);
