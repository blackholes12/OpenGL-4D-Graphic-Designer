...
{
	this->camera.set_direction_to_void();
	this->exposure = 0.25f;
	cameraDirText = 'W';
	if (filePath == "")
	{
		...
		case 0:
		{
			this->skybox4d->switch_mode(0, this->textures3d[TEX_STARS_FIELD_3D], glm::vec3(1.f), glm::vec4(1.f), this->shaders[this->skybox4d->shaderIndex]);
			this->directionLight4d->type = EARTH;
			this->rigidBodies4d.push_back(new RigidBody4D("Player", Hypercapsule(glm::vec4(0.4f, 0.4f, 1.8f, 0.4f)), glm::vec4(0.f, 0.875f, 0.f, 0.f), alg::bivec4(0.f, 0.f, 0.f, 90.f), glm::vec4(0.4f, 0.4f, 1.75f, 0.4f), 65.f, 0.f, 5.7143f, 0.f, true, false, glm::vec4(0.f,0.f,0.f,0.f), alg::bivec4(), true, PURE_WHITE, glm::vec4(1.f, 1.f, 1.f, 1.f), glm::vec4(1.f, 1.f, 1.f, 0.f), CAPSULE4D, WALLD4));
			this->walls4d.push_back(new Wall4D("Floor", Hypercube(glm::vec4(100.f, 0.01f, 100.f, 100.f) / 4.f), glm::vec4(0.f, 0.01f, 0.f, 0.f), alg::bivec4(), glm::vec4(1000.f,0.01f, 1000.f, 1000.f), 0.7f, 1.f, true, GRID2, glm::vec4(0.f, 0.f, 1.f, 0.5f), glm::vec4(1.f, 1.f, 1.f, 0.f), BOX4D, EMITD4));
			//generate_room4D(glm::vec4(0.f, 0.f, 0.f, 0.f), glm::vec4(6, 6, 6, 6), 0, 0, 0, 0, 0, 0, false, false, GRID, glm::vec4(0.f, 1.f, 0.f, 1.f), EMITD4, true, GRID, glm::vec4(0.f, 1.f, 0.f, 1.f), EMITD4, false, GRID, glm::vec4(0.f, 1.f, 0.f, 1.f), EMITD4, false, GRID, glm::vec4(0.f, 1.f, 0.f, 1.f), EMITD4, &this->walls4d);
			//this->walls4d.push_back(new Wall4D("Ground", Hypercube(glm::vec4(1.f, 64.f, 1.f, 1.f) / 2.f), glm::vec4(0.f, 31.8f, 0.f, 0.f), alg::bivec4(), glm::vec4(2000.f, 64.f, 2000.f, 2000.f), 0.7f, 0.25f, false, WOODX, glm::vec4(1.f), glm::vec4(0.f), BOX4D, WALLD4));
			this->waters4d.push_back(new Water4D("Water", Quad4d(glm::vec4(10000.f, 40000.f, 10000.f, 10000.f)), glm::vec4(0, 0.f, 0, 0), glm::vec4(10000.f, 40000.f, 10000.f, 10000.f), NONE, WATERD4));
			this->walls4d.push_back(new Wall4D("WaterFloor", Waterbox4d(glm::vec4(1.f)), glm::vec4(0.f, 0.f, 0.f, 0.f), alg::bivec4(), glm::vec4(9999.f, 55.5f, 9999.f, 9999.f), 0.7f, 0.25f, false, PURE_WHITE, glm::vec4(0.0295f, 0.0295f, 0.0295f, 1.f), glm::vec4(1.f, 1.f, 1.f, 0.f), NONE, EMITD4));
			this->worldTime = 575.f;
			break;
		}
		case 1:
		{
			...
			new HingeConstraint4D(glm::vec4(), glm::vec4(-1.f, -0.7f, 0.5f, 0.5f), glm::vec4(0.f, 0.f, 0.5f, 0.5f), this->rigidBodies4d.size() - 1, {this->rigidBodies4d.size() - 3,true}),
			new HingeConstraint4D(glm::vec4(), glm::vec4(-1.f, -0.7f, 0.5f, -0.5f), glm::vec4(0.f, 0.f, 0.5f, -0.5f), this->rigidBodies4d.size() - 1, {this->rigidBodies4d.size() - 3,true}),
			new HingeConstraint4D(glm::vec4(), glm::vec4(-1.f, -0.7f, -0.5f, 0.5f), glm::vec4(0.f, 0.f, -0.5f, 0.5f), this->rigidBodies4d.size() - 1, {this->rigidBodies4d.size() - 3,true}),
			new HingeConstraint4D(glm::vec4(), glm::vec4(-1.f, -0.7f, -0.5f, -0.5f), glm::vec4(0.f, 0.f, -0.5f, -0.5f), this->rigidBodies4d.size() - 1, {this->rigidBodies4d.size() - 3,true}) });
			this->hingeConstraintsVec.push_back({
			new HingeConstraint4D(glm::vec4(), glm::vec4(1.f, -0.7f, 0.5f, 0.5f), glm::vec4(0.f, 0.f, 0.5f, 0.5f), this->rigidBodies4d.size() - 1, {this->rigidBodies4d.size() - 2,true}),
			new HingeConstraint4D(glm::vec4(), glm::vec4(1.f, -0.7f, 0.5f, -0.5f), glm::vec4(0.f, 0.f, 0.5f, -0.5f), this->rigidBodies4d.size() - 1, {this->rigidBodies4d.size() - 2,true}),
			new HingeConstraint4D(glm::vec4(), glm::vec4(1.f, -0.7f, -0.5f, 0.5f), glm::vec4(0.f, 0.f, -0.5f, 0.5f), this->rigidBodies4d.size() - 1, {this->rigidBodies4d.size() - 2,true}),
			new HingeConstraint4D(glm::vec4(), glm::vec4(1.f, -0.7f, -0.5f, -0.5f), glm::vec4(0.f, 0.f, -0.5f, -0.5f), this->rigidBodies4d.size() - 1, {this->rigidBodies4d.size() - 2,true}) });
			...
			for (int i = 0; i < 127; i++)
			{
				for (int j = 0; j < 1; j++)
				{
					this->pointLights4d.push_back(new PointLight4D(PARTICLE1, glm::vec4(10*i, 66.f, 0, 0), this->pointLights4d.size(), 2.f, glm::vec3(rand() % 256, rand() % 256, rand() % 256)/256.f,10.f));
				}
			}
		...
		case 2:
		{
			...
			this->directionLight4d->type = EARTH;
			this->rigidBodies4d.push_back(new RigidBody4D("Player", Hypercapsule(glm::vec4(0.4f, 0.4f, 1.8f, 0.4f)), glm::vec4(0.f, 64.875f, 0.f, 0.f), alg::bivec4(0.f, 0.f, 0.f, 90.f), glm::vec4(0.4f, 0.4f, 1.75f, 0.4f), 65.f, 0.f, 5.7143f, 0.f, true, false, glm::vec4(0.f), alg::bivec4(), true, PURE_WHITE, glm::vec4(1.f, 1.f, 1.f, 1.f),glm::vec4(1.f,1.f,1.f,0.f), CAPSULE4D, WALLD4));
			this->walls4d.push_back(new Wall4D("Candy", Hypersphere(glm::vec4(0.5f)), glm::vec4(3.05f, 64.15f, 0.f, 0.f), alg::bivec4(), glm::vec4(0.5f), 1.265f, 0.f, true, PURE_GREEN, glm::vec4(1.f), glm::vec4(1.f, 1.f, 1.f, 0.25f), SPHERE4D, WALLD4));
			for (int i(-1); i < 2; i++)
			{
				for (int j(-1); j < 2; j++)
				{
					for (int k(-2); k < 3; k++)
					{
						this->walls4d.push_back(new Wall4D("Obstacle", Hypercube(glm::vec4(1.f) / 2.f), glm::vec4(-2.f + 6 * i, 64.8f, -2.f + 6 * j, 0.f + 6 * k), alg::bivec4(32.f, 8.f, 93.f, 83.f, 35.f, 76.f), glm::vec4(1.f), 0.7f, 1.f, true, PURE_RED, glm::vec4(1.f), glm::vec4(1.f, 1.f, 1.f, 0.f), BOX4D, WALLD4));
						this->walls4d.push_back(new Wall4D("Obstacle", TriPrism(glm::vec4(1.f) / 2.f), glm::vec4(0.f + 6 * i, 65.8f, -2.f + 6 * j, 0.f + 6 * k), alg::bivec4(28.f, 68.f, 90.f, 22.f, 44.f, 66.f), glm::vec4(1.f), 0.7f, 1.f, true, PURE_RED+1, glm::vec4(1.f), glm::vec4(1.f, 1.f, 1.f, 0.f), MESH4D, WALLD4));
						this->walls4d.push_back(new Wall4D("Obstacle", Hypersphere(glm::vec4(1.f) / 2.f), glm::vec4(-2.f + 6 * i, 65.3f, 0.f + 6 * j, 0.f + 6 * k), alg::bivec4(88.f, 20.f, 42.f, 64.f, 26.f, 66.f), glm::vec4(1.f), 0.7f, 1.f, true, PURE_RED+2, glm::vec4(1.f), glm::vec4(1.f, 1.f, 1.f, 0.f), SPHERE4D, WALLD4));
						this->walls4d.push_back(new Wall4D("Obstacle", Hypercone(glm::vec4(1.f) / 2.f), glm::vec4(2.f + 6 * i, 66.8f, 2.f + 6 * j, 0.f + 6 * k), alg::bivec4(88.f, 10.f, 32.f, 54.f, 76.f, 8.f), glm::vec4(1.f), 0.7f, 1.f, true, PURE_RED+3, glm::vec4(1.f), glm::vec4(1.f, 1.f, 1.f, 0.f), MESH4D, WALLD4));
						this->walls4d.push_back(new Wall4D("Obstacle", Hypercylinder(glm::vec4(1.f) / 2.f), glm::vec4(-2.f + 6 * i, 66.3f, 2.f + 6 * j, 0.f + 6 * k), alg::bivec4(30.f, 52.f, 74.f, 6.f, 28.f, 50.f), glm::vec4(1.f), 0.7f, 1.f, true, PURE_RED+4, glm::vec4(1.f), glm::vec4(1.f, 1.f, 1.f, 0.f), MESH4D, WALLD4));
						this->walls4d.push_back(new Wall4D("Obstacle", Pentachoron(glm::vec4(1.f) / 2.f), glm::vec4(2.f + 6 * i, 67.8f, -2.f + 6 * j, 0.f + 6 * k), alg::bivec4(72.f, 4.f, 26.f, 48.f, 70.f, 2.f), glm::vec4(1.f), 0.7f, 1.f, true, PURE_RED+5, glm::vec4(1.f), glm::vec4(1.f, 1.f, 1.f, 0.f), MESH4D, WALLD4));
						this->walls4d.push_back(new Wall4D("Obstacle", Pyramid4D(glm::vec4(1.f) / 2.f), glm::vec4(2.f + 6 * i, 67.3f, 0.f + 6 * j, 0.f + 6 * k), alg::bivec4(24.f, 46.f, 68.f, 90.f, 22.f, 44.f), glm::vec4(1.f), 0.7f, 1.f, true, PURE_RED+6, glm::vec4(1.f), glm::vec4(1.f, 1.f, 1.f, 0.f), MESH4D, WALLD4));
						this->walls4d.push_back(new Wall4D("Obstacle", Hexadecachoron(glm::vec4(1.f) / 2.f), glm::vec4(0.f + 6 * i, 65.8f, 2.f + 6 * j, 0.f + 6 * k), alg::bivec4(66.f, 88.f, 20.f, 42.f, 64.f, 86.f), glm::vec4(1.f), 0.7f, 1.f, true, PURE_RED+7, glm::vec4(1.f), glm::vec4(1.f, 1.f, 1.f, 0.f), MESH4D, WALLD4));
					}
				}
			}

			//generate_room4D(glm::vec4(0.f, 64.f, 0.f, 0.f), glm::vec4(6, 6, 6, 6), 0, 0, 0, 0, 0, 0, false, false, GRID2, glm::vec4(0.f, 1.f, 0.f, 1.f), EMITD4, true, GRID2, glm::vec4(0.f, 1.f, 0.f, 1.f), EMITD4, false, GRID2, glm::vec4(0.f, 1.f, 0.f, 1.f), EMITD4, false, GRID2, glm::vec4(0.f, 1.f, 0.f, 1.f), EMITD4, &this->walls4d);
			...
			this->walls4d.push_back(new Wall4D("Hypercube", Hypercube(glm::vec4(1.f, 6.f, 1.f, 1.f) / 2.f), glm::vec4(13.5f + 3.f, 67, -3.f, 24.5f - 3.f), alg::bivec4(), glm::vec4(1.f, 6.f, 1.f, 1.f), 0.7f, 0.25f, true, YELLOWMARBLE, glm::vec4(1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, WALLD4));
			this->walls4d.push_back(new Wall4D("Hypercube", Hypercube(glm::vec4(1.f, 6.f, 1.f, 1.f) / 2.f), glm::vec4(13.5f - 3.f, 67, -3.f, 24.5f - 3.f), alg::bivec4(), glm::vec4(1.f, 6.f, 1.f, 1.f), 0.7f, 0.25f, true, STARS, glm::vec4(1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, WALLD4));
			this->walls4d.push_back(new Wall4D("Hypercube", Hypercube(glm::vec4(1.f, 6.f, 1.f, 1.f) / 2.f), glm::vec4(13.5f + 3.f, 67, 3.f, 24.5f - 3.f), alg::bivec4(), glm::vec4(1.f, 6.f, 1.f, 1.f), 0.7f, 0.25f, true, MARBLE_C1, glm::vec4(1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, WALLD4));
			this->walls4d.push_back(new Wall4D("Hypercube", Hypercube(glm::vec4(1.f, 6.f, 1.f, 1.f) / 2.f), glm::vec4(13.5f - 3.f, 67, 3.f, 24.5f - 3.f), alg::bivec4(), glm::vec4(1.f, 6.f, 1.f, 1.f), 0.7f, 0.25f, true, MARBLE_C2, glm::vec4(1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, WALLD4));
			this->walls4d.push_back(new Wall4D("Hypercube", Hypercube(glm::vec4(1.f, 6.f, 1.f, 1.f) / 2.f), glm::vec4(13.5f + 3.f, 67, -3.f, 24.5f + 3.f), alg::bivec4(), glm::vec4(1.f, 6.f, 1.f, 1.f), 0.7f, 0.25f, true, MARBLE_C3, glm::vec4(1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, WALLD4));
			this->walls4d.push_back(new Wall4D("Hypercube", Hypercube(glm::vec4(1.f, 6.f, 1.f, 1.f) / 2.f), glm::vec4(13.5f - 3.f, 67, -3.f, 24.5f + 3.f), alg::bivec4(), glm::vec4(1.f, 6.f, 1.f, 1.f), 0.7f, 0.25f, true, MARBLE_C4, glm::vec4(1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, WALLD4));
			this->walls4d.push_back(new Wall4D("Hypercube", Hypercube(glm::vec4(1.f, 6.f, 1.f, 1.f) / 2.f), glm::vec4(13.5f + 3.f, 67, 3.f, 24.5f + 3.f), alg::bivec4(), glm::vec4(1.f, 6.f, 1.f, 1.f), 0.7f, 0.25f, true, MARBLE_C5, glm::vec4(1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, WALLD4));
			this->walls4d.push_back(new Wall4D("Hypercube", Hypercube(glm::vec4(1.f, 6.f, 1.f, 1.f) / 2.f), glm::vec4(13.5f - 3.f, 67, 3.f, 24.5f + 3.f), alg::bivec4(), glm::vec4(1.f, 6.f, 1.f, 1.f), 0.7f, 0.25f, true, MARBLE_C2, glm::vec4(1.f),glm::vec4(1.f,1.f,1.f,0.f), BOX4D, WALLD4));
		...
		case 3:
		{
			...
			this->sticks4d.push_back(new Stick4D(glm::vec4(0.f), 1, { 3,true }, 5.f, WHITECONCRETE, glm::vec4(1.f), WALLD4));
			...
			this->shifts4d.push_back(new Shift4D({ {glm::vec4(-10.3f, 63.9f, 0.f, 0.f), 1.f}, {glm::vec4(-10.3f, 66.9f, 0.f, 0.f), 2.f}, {glm::vec4(-10.3f, 66.9f, 3.f, 0.f), 5.f}, {glm::vec4(-13.3f, 66.9f, 3.f, 0.f), 4.f}, {glm::vec4(-10.3f, 63.9f, 0.f, 0.f), 0.f} }, 2));
			this->rotates4d.push_back(new Rotate4D(glm::vec4(-10.3f, 63.9f, 0.f, 0.f), glm::vec4(), alg::bivec4(), alg::bivec4(0.f, 0.f, 0.f, 1.f, 0.f, 0.f), true, 2, { 0,false }));
		...
		case 4:
		{
			...
			this->walls4d.push_back(new Wall4D("WaterFloor", Waterbox4d(glm::vec4(1.f)), glm::vec4(0.f,55.5f,0.f,0.f), alg::bivec4(), glm::vec4(9999.f, 55.5f, 9999.f, 9999.f), 0.7f, 0.25f, false, PURE_WHITE, glm::vec4(0.0295f, 0.0295f, 0.0295f, 1.f), glm::vec4(1.f, 1.f, 1.f, 0.f), NONE, EMITD4));
			this->directionLight4d->type = EARTH;
			this->worldTime = 150.f;
			break;
		}
		case 5:
		{
			...
			this->rotates4d.push_back(new Rotate4D(glm::vec4(-9.5f, 75.5f, 2, 0), glm::vec4(), alg::bivec4(), alg::bivec4(1.f, 0.f, 0.f, 0.f, 0.f, 0.f), true, 1, { 0,false }));
			...
			this->rotates4d.push_back(new Rotate4D(glm::vec4(), glm::vec4(2.f, 0.f, 0.f, 0.f), alg::bivec4(), alg::bivec4(0.f, 0.f, 0.f, 0.f, 0.f, 0.f), true, 2, { 1, true }));
