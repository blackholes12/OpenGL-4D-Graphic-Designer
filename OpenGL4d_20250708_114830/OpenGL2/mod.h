...
static void mul_bv(alg::vec4 v, alg::bivec4 b, alg::vec4* a1, alg::trivec4* a3)
{
...
static void mul_v(alg::bivec4 b, alg::vec4 v, alg::vec4* a1, alg::trivec4* a3)
{
	*a1 = dot_v(b, v);
	*a3 = wedge_v(b, v);
}
...
static void decompose(alg::bivec4 b, alg::bivec4* bPlus, alg::bivec4* bMinus) {
...
static void decompose(alg::rotor4 r, alg::rotor4* rPlus, alg::rotor4* rMinus)
{
