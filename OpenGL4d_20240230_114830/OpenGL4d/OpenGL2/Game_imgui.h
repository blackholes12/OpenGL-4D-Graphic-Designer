...
const char* paintingColorText = "R1/G1/B1/A1";
const char* paintingShapeText = "Sphere";
const char* trailFadeTypeText = "Forget";
const char* objectRenderingText = "Objects And Wire Frames";
...
void Game::imgui_use() {
	...
	if (ImGui::TreeNodeEx("Object", 2))
	{
		...
		if (ImGui::TreeNodeEx("Build", 1))
		{
			...
			if (ImGui::ColorEdit4("Painting Color", &this->buildColor.x))
			{
				...
				paintingColorText = (const char*)ss;
			}
	...
	if (ImGui::TreeNodeEx("Display", 2))
	{
		...
		if (ImGui::BeginCombo("Trail Fade Type", trailFadeTypeText))
		{
			...
			if (ImGui::Selectable("None")) {
				this->shaders[TRAIL4D]->use();
				this->shaders[TRAIL4D]->set1i(NONE_FADE, "trailFadeType");
				trailFadeTypeText = "None";
			}
			ImGui::EndCombo();
		}
		ImGui::TreePop();
	...
	if (ImGui::BeginCombo("Objects Rendering", objectRenderingText))
	{
		if (ImGui::Selectable("Objects"))
		{
			this->frameType = 0;
			objectRenderingText = "Objects";
		}
