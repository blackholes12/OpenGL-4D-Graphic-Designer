...
void Game::imgui_use() {
	...
	if (ImGui::TreeNodeEx("Object", 2))
	{
		...
		if (ImGui::TreeNodeEx("Build", 1))
		{
			...
			ImGui::Text("(1)Frictional Coefficient (2)Elastic Coefficient");
			ImGui::DragFloat2("", &this->buildParameter.z, 0.1f, 0.f, 20.f);
			...
			ImGui::DragFloat2("", &this->buildParameter.x, 0.1f, 0.f, 20.f);
