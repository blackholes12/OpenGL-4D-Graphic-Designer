...
static vector<Collision*> sphere_to_sphere(Object4D* a0, Object4D* b0,int index1, int index2, vector<Collision*> collisions, bool isInverse)
{
    ...
    return collisions;
    for (Collision* i : collisions) { delete i, i = nullptr; }
}
            ...
            abs(posBToA.w) < a->scale4D.w / 2.f + radiousB)
        {
            ...
            if (gjk(a, b, &simplex))
            {
                ...
                if (depth0 > 0.f)
                {
                    ...
                    std::vector<hypercube::Edge4D> edges4DA;
                    std::vector<hypercube::Edge4D> edges4DB;
                    std::vector<hypercube::Face4D> faces4DA;
                    std::vector<hypercube::Face4D> faces4DB;
                    for (int i = 0; i < 16; i++)
                    {
                        glm::vec4 vertexPos4D = body_pos_to_world(a, hypercube::vertices4D[i] * a->scale4D);
                        if (supportDistanceA - dot(vertexPos4D - a->position4D, normal0) < 0.002f)
                        {
                    ...
                    for (int i = 0; i < 16; i++)
                    {
                        ...
                        if (supportDistanceB - dot(vertexPos4D - b->position4D, -normal0) < 0.002f)
                        {
                    ...
                    for (int i = 0; i < 32; i++)
                    {
                        ...
                        if (supportDistanceA - dot(edgeVertexPos4D1 - a->position4D, normal0) < 0.002f &&
                            supportDistanceA - dot(edgeVertexPos4D2 - a->position4D, normal0) < 0.002f)
                        {
                    ...
                    for (int i = 0; i < 32; i++)
                    {
                        ...
                        if (supportDistanceB - dot(edgeVertexPos4D1 - b->position4D, -normal0) < 0.002f &&
                            supportDistanceB - dot(edgeVertexPos4D2 - b->position4D, -normal0) < 0.002f)
                        {
                    ...
                    for (int i = 0; i < 24; i++)
                    {
                        ...
                        if (supportDistanceA - dot(faceVertexPos4D1 - a->position4D, normal0) < 0.002f &&
                            supportDistanceA - dot(faceVertexPos4D2 - a->position4D, normal0) < 0.002f &&
                            supportDistanceA - dot(faceVertexPos4D3 - a->position4D, normal0) < 0.002f)
                        {
                    ...
                    for (int i = 0; i < 24; i++)
                    {
                        ...
                        if (supportDistanceB - dot(faceVertexPos4D1 - b->position4D, -normal0) < 0.002f &&
                            supportDistanceB - dot(faceVertexPos4D2 - b->position4D, -normal0) < 0.002f &&
                            supportDistanceB - dot(faceVertexPos4D3 - b->position4D, -normal0) < 0.002f)
                        {
                    ...
                    for (int i = 0; i < vertices4DA.size(); i++)
                    {
                        ...
                        if (line_sigment_detect_box4D(startPos4D, startPos4D + 120000.f * world_vec_to_body(b, -normal0), b->scale4D+glm::vec4(0.00001f), &none, &none))
                        {
                            ...
                            if (depth > 0.f)
                            {
                                collisions.push_back(new Collision(index1, index2, 1.f, 1.f, inverse(normal0, isInverse), depth, vertices4DA[i] - depth * normal0 / 2.f));
                                collisionCounter++;
                            }
                        }
                    }
                    for (int i = 0; i < vertices4DB.size(); i++)
                    {
                        ...
                        if (line_sigment_detect_box4D(startPos4D, startPos4D + 120000.f * world_vec_to_body(a, normal0), a->scale4D + glm::vec4(0.00001f), &none, &none))
                        {
                            ...
                            if (depth > 0.f)
                            {
                                collisions.push_back(new Collision(index1, index2, 1.f, 1.f, inverse(normal0, isInverse), depth, vertices4DB[i] + depth * normal0 / 2.f));
                                collisionCounter++;
                            }
                        }
                    }
                    for (int i = 0; i < edges4DA.size(); i++)
                    {
                        for (int j = 0; j < faces4DB.size(); j++)
                        {
                            if (is_edge_in_square(normal0, edges4DA[i].vertices4D[0], edges4DA[i].vertices4D[1], faces4DB[j].vertices4D[0], faces4DB[j].vertices4D[1], faces4DB[j].vertices4D[2]))
                            {
                                ...
                                if (depth > 0.f)
                                {
                                    collisions.push_back(new Collision(index1, index2, 1.f, 1.f, inverse(normal0, isInverse), depth, contact));
                                    collisionCounter++;
                                }
                            }
                        }
            ...
            abs(posAToB.w) < b->scale4D.w / 2.f + meshRadious)
        {
            ...
            if (gjk(a, b, &simplex))
            {
                ...
                if (depth0 > 0.f)
                {
                    ...
                    std::vector<hypercube::Face4D> faces4DA;
                    std::vector<hypercube::Face4D> faces4DB;
                    std::vector<hypercube::Tetra4D> tetras4DA;
                    ...
                    for (int i = 0; i < a->primitive4D.get_size_of_vertices4D() / 4; i++)
                    {
                        ...
                        if (supportDistanceA - dot(tetraVertexPos4D1 - a->position4D, normal0) < 0.002f &&
                            supportDistanceA - dot(tetraVertexPos4D2 - a->position4D, normal0) < 0.002f &&
                            supportDistanceA - dot(tetraVertexPos4D3 - a->position4D, normal0) < 0.002f &&
                            supportDistanceA - dot(tetraVertexPos4D4 - a->position4D, normal0) < 0.002f)
                        {
                                ...
                                for (size_t i = 0; i < 6; i++)
                                {
                                        ...
                                        a->primitive4D.vertexData4D[cubeIndex + 4 * i + 3]))
                                    {
                                            ...
                                            a->position4D + a->primitive4D.vertexData4D[cubeIndex + 4 * i + 3]))
                                        {
                                            ...
                                            {
                                                massAdjustment += 1.f;
                                                collisions.push_back(new Collision(index1, index2, (float)massAdjustment, (float)massAdjustment, normal, depth, contacts));
                                            }
                                        }
                                    }
                                }
        ...
        abs(a->position4D.w - b->position4D.w) < meshRadiousA + meshRadiousB)
    {
        ...
        if (gjk(a, b, &simplex))
        {
            ...
            if (depth0 > 0.f)
            {
                ...
                std::vector<hypercube::Face4D> faces4DB;
                std::vector<hypercube::Tetra4D> tetras4DA;
                std::vector<hypercube::Tetra4D> tetras4DB;
                for (int i = 0; i < a->primitive4D.get_size_of_vertices4D(); i++)
                {
                    glm::vec4 vertexPos4D = body_pos_to_world(a, a->primitive4D.vertexData4D[i] * a->scale4D);
                    if (supportDistanceA - dot(vertexPos4D - a->position4D, normal0) < 0.002f)
                ...
                for (int i = 0; i < b->primitive4D.get_size_of_vertices4D() / 4; i++)
                {
                    ...
                    if (supportDistanceB - dot(tetraVertexPos4D1 - b->position4D, -normal0) < 0.002f &&
                        supportDistanceB - dot(tetraVertexPos4D2 - b->position4D, -normal0) < 0.002f &&
                        supportDistanceB - dot(tetraVertexPos4D3 - b->position4D, -normal0) < 0.002f &&
                        supportDistanceB - dot(tetraVertexPos4D4 - b->position4D, -normal0) < 0.002f)
                    {
...
static vector<Collision*> mesh_to_mesh(Object4D* a, Object4D* b, int index1, int index2, vector<Collision*> collisions, bool isInverse)
{
        ...
        abs(a->position4D.w - b->position4D.w) < meshRadiousA + meshRadiousB)
    {
        ...
        if (gjk(a, b, false, 12, &simplex))
        {
            ...
            normal = inverse(epa22(a, b, 24, simplex), isInverse);
            for (int i = 0; i < a->primitive4D.get_size_of_vertices4D() / 4; i++)
            {
                                    ...
                                    if (depth > 0.f)
                                    {
                                        if (abs(dot(normal, normalize(lineVertex4D1OfB - lineVertex4D2OfB))) < 0.001f)
                                        {
                                            if (length(lineVertex4D1OfB - lineVertex4D2OfB) > 0.001f)
                                            {
                                                ...
                                                if (is_edge_in_face(normal2, lineVertex4D1OfB, lineVertex4D2OfB, faceVertex4D1Of1, faceVertex4D2Of1, faceVertex4D3Of1, &contact))
                                                {
                                    ...
                                    if (depth > 0.f)
                                    {
                                        if (abs(dot(normal, normalize(lineVertex4D1Of1 - lineVertex4D2Of1))) < 0.001f)
                                        {
                                            if (length(lineVertex4D1Of1 - lineVertex4D2Of1) > 0.001f)
                                            {
                                                ...
                                                if (is_edge_in_face(normal2, lineVertex4D1Of1, lineVertex4D2Of1, faceVertex4D1OfB, faceVertex4D2OfB, faceVertex4D3OfB, &contact))
                                                {
