...
public:
	...
	bool getKeyOnPress(GLFWwindow* window, int key)
	{
		...
		if (glfwGetKey(window, key) == GLFW_PRESS && isRelease)
		{
			isRelease = false;
			isOnPress = true;
		}
	...
	bool getKeyOnRelease(GLFWwindow* window, int key)
	{
		...
		if (glfwGetKey(window, key) == GLFW_RELEASE && isPress)
		{
			isPress = false;
			isOnRelease = true;
		}
	...
	bool getMouseOnPress(GLFWwindow* window, int mouseButton)
	{
		...
		if (glfwGetMouseButton(window, mouseButton) == GLFW_PRESS && isRelease)
		{
			isRelease = false;
			isOnPress = true;
		}
	...
	bool getMouseOnRelease(GLFWwindow* window, int mouseButton)
	{
		...
		if (glfwGetMouseButton(window, mouseButton) == GLFW_RELEASE && isPress)
		{
			isPress = false;
			isOnRelease = true;
		}
