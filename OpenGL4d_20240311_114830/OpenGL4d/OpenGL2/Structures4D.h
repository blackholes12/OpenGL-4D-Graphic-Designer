...
static void generate_dynamite4D(glm::vec4 position, Texture3D* color,std::vector<Wall4D*>* dynamites4D, Shader* shader)
{
...
static void generate_dynamite4D(glm::vec4 position, Texture3D* color, std::vector<RigidBody4D*>* dynamites4D, bool isGravity, Shader* shader)
{
